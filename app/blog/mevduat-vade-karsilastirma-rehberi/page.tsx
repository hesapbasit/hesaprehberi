...
const pageTitle = "Mevduat Vade Karşılaştırma Rehberi";
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "vadeli mevduat vade seçimi",
    "32 günlük mevduat",
    "46 günlük mevduat",
    "92 günlük mevduat",
    "181 günlük mevduat",
    "kısa vade uzun vade mevduat",
    "mevduat net kazanç karşılaştırma",
    "vadeli hesap vade karşılaştırma",
    "mevduat efektif getiri",
    "mevduat likidite karşılaştırma",
    "mevduat stopaj vade",
    "en uygun mevduat vadesi",
    "vadeli mevduat kazanç hesabı",
  ],
  alternates: {
...
const tableOfContents = [
  { id: "vade-karsilastirma-nedir", label: "Mevduat vade karşılaştırma nedir?" },
  { id: "neden-vade-onemli", label: "Vade neden önemlidir?" },
  { id: "gerekli-veriler", label: "Karşılaştırmada gerekli veriler" },
  { id: "kisa-vade", label: "Kısa vadeli mevduat" },
  { id: "orta-vade", label: "Orta vadeli mevduat" },
  { id: "uzun-vade", label: "Uzun vadeli mevduat" },
  { id: "stopaj-etkisi", label: "Stopaj vadeleri nasıl etkiler?" },
  { id: "ornek-hesaplama", label: "Adım adım vade karşılaştırması" },
  { id: "net-kazanc", label: "Net kazanç karşılaştırması" },
  { id: "efektif-getiri", label: "Efektif yıllık getiri" },
  { id: "likidite", label: "Likidite ve erken bozma riski" },
  { id: "yenileme-riski", label: "Yenileme ve faiz değişim riski" },
  { id: "kontrol-listesi", label: "Vade seçimi kontrol listesi" },
...
const faqItems = [
  {
    question: "Mevduat vade karşılaştırma nedir?",
    answer:
      "Farklı vade sürelerinin aynı ana para üzerinden net faiz, stopaj, likidite ve yıllıklandırılmış getiri açısından karşılaştırılmasıdır.",
  },
  {
    question: "En yüksek faiz oranı hangi vadede olur?",
    answer:
      "Bu durum piyasa koşullarına ve bankanın fiyatlamasına göre değişir; her zaman en uzun vade en yüksek oranı sunmaz.",
  },
  {
    question: "32 günlük mevduatın avantajı nedir?",
    answer:
      "Paraya daha sık erişim ve oranları kısa aralıklarla yeniden değerlendirme imkânı sağlar.",
  },
  {
    question: "Uzun vadeli mevduatın avantajı nedir?",
    answer:
      "Faiz oranını daha uzun süre sabitleyebilir ve sık yenileme ihtiyacını azaltabilir.",
  },
  {
    question: "Kısa vade her zaman daha mı kazançlıdır?",
    answer:
      "Hayır. Yenileme oranları düşerse kısa vadede toplam kazanç uzun vadeden düşük kalabilir.",
  },
  {
    question: "Uzun vade her zaman daha mı güvenlidir?",
    answer:
      "Oranı sabitler; ancak paraya erken ihtiyaç duyulursa faiz kaybı riski yaratabilir.",
  },
  {
    question: "Vadeler net kazanç üzerinden nasıl karşılaştırılır?",
    answer:
      "Her vade için brüt faiz hesaplanır, stopaj düşülür ve vade sonu net kazanç aynı ana para üzerinden karşılaştırılır.",
  },
  {
    question: "Farklı gün sayılarını doğrudan karşılaştırmak doğru mu?",
    answer:
      "Tek başına net tutar yeterli değildir; efektif yıllık getiri ve likidite de birlikte değerlendirilmelidir.",
  },
  {
    question: "Efektif yıllık getiri nedir?",
    answer:
      "Vadenin yıl içinde aynı koşullarla yenilendiği varsayımıyla oluşabilecek yıllıklandırılmış getiridir.",
  },
  {
    question: "Stopaj vade seçimini etkiler mi?",
    answer:
      "Evet. Geçerli mevzuata göre vadelere uygulanabilen farklı stopaj oranları net kazancı değiştirebilir.",
  },
  {
    question: "Vade dolmadan hesap bozulursa ne olur?",
    answer:
      "Ürün şartlarına göre faiz tamamen veya kısmen kaybedilebilir.",
  },
  {
    question: "Faiz oranları yükselirken hangi vade tercih edilir?",
    answer:
      "Kısa vade, yeni yüksek oranlara daha hızlı geçiş sağlayabilir; ancak yükseliş kesin değildir.",
  },
  {
    question: "Faiz oranları düşerken hangi vade avantajlı olabilir?",
    answer:
      "Yüksek oranı daha uzun süre sabitleyen uzun vade avantaj sağlayabilir.",
  },
  {
    question: "Vade yenileme riski nedir?",
    answer:
      "Kısa vade sonunda yeni faiz oranının önceki orandan daha düşük olma ihtimalidir.",
  },
  {
    question: "Likidite ihtiyacı vade seçimini nasıl etkiler?",
    answer:
      "Yakın zamanda paraya ihtiyaç varsa kısa vade veya kısmi çekime izin veren ürünler daha uygun olabilir.",
  },
  {
    question: "Mevduat vade karşılaştırma aracı ne gösterir?",
    answer:
      "Farklı vadelerde brüt faiz, stopaj, net kazanç, vade sonu bakiye ve yıllıklandırılmış getiriyi karşılaştırır.",
  },
  {
    question: "Hesaplama sonucu kesin midir?",
    answer:
      "Hayır. Sonuç girilen oranlara dayanır; kesin getiri bankanın işlem anındaki koşullarına göre değişir.",
  },
  {
      ...
      <main className="min-h-screen bg-slate-50">
        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[280px_minmax(0,1fr)] lg:px-8 lg:py-14">
          ...
          <article className="min-w-0 space-y-8">
            <ArticleSection
              id="vade-karsilastirma-nedir"
              eyebrow="Temel bilgi"
              title="Mevduat vade karşılaştırma nedir?"
            ...
            >
              <div className="space-y-4">
                ...
                />
                <MistakeCard
                  title="Uzun vadeli mevduatnı göz ardı etmek"
