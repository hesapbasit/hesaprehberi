...
const pageTitle = "Mevduat Reel Getiri Rehberi";
const pageDescription =
  "Mevduat reel getirisi nasıl hesaplanır? Nominal faiz, stopaj, enflasyon, satın alma gücü ve gerçek kazanç ilişkisini ayrıntılı örneklerle öğrenin.";
const canonicalPath = "/blog/mevduat-reel-getiri-rehberi";
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "mevduat satın alma gücü",
    "net reel getiri",
    "stopaj sonrası reel faiz",
    "vadeli mevduat reel kazanç",
    "enflasyona göre faiz getirisi",
...
const tableOfContents = [
  { id: "reel-getiri-nedir", label: "Mevduat reel getirisi nedir?" },
  { id: "nominal-reel-fark", label: "Nominal ve reel getiri farkı" },
  { id: "gerekli-veriler", label: "Hesaplamada gerekli veriler" },
  { id: "temel-formul", label: "Reel getiri formülü" },
  { id: "stopaj-etkisi", label: "Stopaj reel getiriyi nasıl etkiler?" },
  { id: "enflasyon-etkisi", label: "Enflasyon satın alma gücünü nasıl değiştirir?" },
  { id: "pozitif-negatif", label: "Pozitif ve negatif reel getiri" },
  { id: "ornek-hesaplama", label: "Adım adım reel getiri hesabı" },
  { id: "farkli-enflasyon", label: "Farklı enflasyon senaryoları" },
  { id: "vade-etkisi", label: "Vadenin reel getiriye etkisi" },
  { id: "bilesik-etki", label: "Bileşik faiz ve reel getiri" },
  { id: "reel-hedef", label: "Reel getiri hedefi belirleme" },
  { id: "kontrol-listesi", label: "Reel getiri kontrol listesi" },
...
const faqItems = [
  {
    question: "Mevduat reel getirisi nedir?",
    answer:
      "Mevduatın stopaj sonrası net kazancından enflasyon etkisi çıkarıldığında kalan gerçek satın alma gücü değişimidir.",
  },
  {
    question: "Nominal getiri ile reel getiri arasındaki fark nedir?",
    answer:
      "Nominal getiri hesapta görülen faiz kazancıdır; reel getiri bu kazancın enflasyon karşısındaki gerçek değeridir.",
  },
  {
    question: "Reel getiri nasıl hesaplanır?",
    answer:
      "Yaklaşık yöntemde net faiz oranından enflasyon oranı çıkarılır; kesin yöntemde oranlar bölme formülüyle karşılaştırılır.",
  },
  {
    question: "Stopaj reel getiriyi düşürür mü?",
    answer:
      "Evet. Stopaj net faiz oranını azalttığı için enflasyon sonrası kalan reel getiriyi de düşürür.",
  },
  {
    question: "Pozitif reel getiri ne demektir?",
    answer:
      "Net mevduat getirisi enflasyonun üzerinde olduğunda satın alma gücünün artmasıdır.",
  },
  {
    question: "Negatif reel getiri ne demektir?",
    answer:
      "Mevduat faizi kazanılsa bile net getiri enflasyonun altında kalırsa satın alma gücünün azalmasıdır.",
  },
  {
    question: "Sıfır reel getiri mümkün mü?",
    answer:
      "Evet. Net getiri enflasyona yaklaşık eşitse satın alma gücü korunur.",
  },
  {
    question: "Aylık enflasyonla mevduat getirisi karşılaştırılabilir mi?",
    answer:
      "Evet; ancak her iki oran aynı döneme çevrilerek karşılaştırılmalıdır.",
  },
  {
    question: "Yıllık faiz ile aylık enflasyon doğrudan karşılaştırılır mı?",
    answer:
      "Hayır. Oranlar aynı zaman dilimine dönüştürülmeden yapılan karşılaştırma yanıltıcıdır.",
  },
  {
    question: "Bileşik faiz reel getiriyi artırır mı?",
    answer:
      "Faiz ana paraya eklenip yeniden değerlendirilirse nominal kazanç artabilir; enflasyon aynı kaldığında reel getiri de iyileşebilir.",
  },
  {
    question: "Vade uzadıkça reel getiri kesin artar mı?",
    answer:
      "Hayır. Faiz oranı, enflasyon ve yenileme koşulları değişebileceği için kesin artış garanti değildir.",
  },
  {
    question: "Reel getiri hesabında beklenen enflasyon kullanılabilir mi?",
    answer:
      "Gelecek dönem planlamasında tahmini enflasyon kullanılabilir; ancak sonuç senaryoya dayalı olur.",
  },
  {
    question: "Gerçekleşen enflasyon neden daha doğru sonuç verir?",
    answer:
      "Dönem sonunda oluşan satın alma gücü kaybını fiilen gösterdiği için gerçekleşmiş reel getiriyi daha doğru hesaplar.",
  },
  {
    question: "Kur artışı reel getiri hesabına dahil edilir mi?",
    answer:
      "Standart reel getiri hesabı enflasyonu esas alır; döviz bazlı değerlendirme ayrı bir karşılaştırmadır.",
  },
  {
    question: "Mevduat reel getiri aracı ne gösterir?",
    answer:
      "Net faiz, enflasyon ve vade bilgilerine göre satın alma gücü değişimini ve reel kazancı tahmin eder.",
  },
  {
    question: "Reel getiri negatifse mevduat zarar mı ettirir?",
    answer:
      "Nominal olarak faiz kazancı vardır; ancak satın alma gücü açısından kayıp oluşabilir.",
  },
  {
    question: "Hesaplama sonucu kesin midir?",
    answer:
      "Geçmiş dönem için gerçekleşen verilerle daha nettir; gelecek dönem hesapları varsayıma dayanır.",
  },
  {
      ...
      <main className="min-h-screen bg-slate-50">
        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[280px_minmax(0,1fr)] lg:px-8 lg:py-14">
          ...
          <article className="min-w-0 space-y-8">
            <ArticleSection
              id="reel-getiri-nedir"
              eyebrow="Temel bilgi"
              title="Mevduat reel getirisi nedir?"
            ...
            >
              <div className="space-y-4">
                ...
                />
                <MistakeCard
                  title="Enflasyon satın alma gücünü nasıl değiştirir?nı göz ardı etmek"
