...
const pageTitle = "Mevduat Faiz Oranı Karşılaştırma Rehberi";
const pageDescription =
  "Mevduat faiz oranları nasıl karşılaştırılır? Brüt ve net faiz, stopaj, vade, gün esası, hoş geldin faizi ve toplam kazancı örneklerle öğrenin.";
const canonicalPath = "/blog/mevduat-faiz-orani-karsilastirma-rehberi";
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "mevduat faiz karşılaştırma",
    "brüt net faiz farkı",
    "hoş geldin faizi",
    "vadeli hesap oranları",
    "mevduat stopaj karşılaştırma",
    "mevduat kazanç hesaplama",
    "günlük faiz karşılaştırma",
    "vade karşılaştırma",
    "banka mevduat oranları",
    "mevduat toplam getiri",
  ],
  alternates: {
...
const tableOfContents = [
  { id: "faiz-orani-karsilastirma-nedir", label: "Mevduat faiz oranı karşılaştırma nedir?" },
  { id: "neden-sadece-oran-yetmez", label: "Neden sadece faiz oranı yetmez?" },
  { id: "karsilastirmada-kullanilan-veriler", label: "Karşılaştırmada kullanılan veriler" },
  { id: "brut-net-faiz", label: "Brüt ve net faiz farkı" },
  { id: "stopaj-etkisi", label: "Stopaj karşılaştırmayı nasıl etkiler?" },
  { id: "vade-gun-esasi", label: "Vade ve gün esası" },
  { id: "hos-geldin-faizi", label: "Hoş geldin faizi nasıl değerlendirilir?" },
  { id: "ornek-karsilastirma", label: "Adım adım örnek karşılaştırma" },
  { id: "farkli-vadeler", label: "Farklı vadelerin karşılaştırılması" },
  { id: "efektif-getiri", label: "Efektif yıllık getiri" },
  { id: "kampanya-kosullari", label: "Kampanya koşulları ve alt limitler" },
  { id: "reel-getiri", label: "Enflasyon sonrası reel getiri" },
  { id: "kontrol-listesi", label: "Karşılaştırma kontrol listesi" },
...
const faqItems = [
  {
    ...
    answer:
      "Farklı bankaların veya ürünlerin faiz oranı, vade, stopaj, alt limit ve kampanya koşullarını aynı para tutarı üzerinden karşılaştırmaktır.",
  },
  {
    question: "En yüksek faiz oranı her zaman en yüksek kazancı verir mi?",
    answer:
      "Hayır. Stopaj, gün esası, vade, alt limit, hoş geldin süresi ve ek koşullar net kazancı değiştirebilir.",
  },
  {
    question: "Brüt faiz ile net faiz arasındaki fark nedir?",
    answer:
      "Brüt faiz vergiler düşülmeden önceki getiridir; net faiz stopaj ve varsa diğer kesintiler sonrası elde kalan tutardır.",
  },
  {
    question: "Stopaj karşılaştırmayı nasıl etkiler?",
    answer:
      "Aynı brüt oran farklı vade veya ürünlerde farklı net kazanca dönüşebilir; bu nedenle karşılaştırma net tutar üzerinden yapılmalıdır.",
  },
  {
    question: "32 gün ve 35 gün vadeler nasıl karşılaştırılır?",
    answer:
      "Aynı ana para için net kazanç, gün sayısı ve efektif getiri birlikte değerlendirilmelidir.",
  },
  {
    question: "Hoş geldin faizi nedir?",
    answer:
      "Yeni müşteri veya yeni para için sınırlı süreyle sunulan yüksek faiz oranıdır.",
  },
  {
    question: "Hoş geldin faizi bittikten sonra ne olur?",
    answer:
      "Hesap çoğunlukla standart veya daha düşük yenileme oranına geçer; sonraki dönem getirisi ayrıca kontrol edilmelidir.",
  },
  {
    question: "Mevduat faizinde alt limit önemli midir?",
    answer:
      "Evet. İlan edilen yüksek oran yalnızca belirli tutarın üzerindeki bakiyeler için geçerli olabilir.",
  },
  {
    question: "Üst limit var mı?",
    answer:
      "Bazı kampanyalarda yüksek oran yalnızca belirli bakiyeye kadar uygulanır; üstte kalan tutar daha düşük faiz alabilir.",
  },
  {
    question: "Gün esası nedir?",
    answer:
      "Faiz hesabında yılın 360 veya 365 gün kabul edilmesidir; aynı oran farklı net sonuç doğurabilir.",
  },
  {
    question: "Efektif yıllık getiri nedir?",
    answer:
      "Faizin yıl içinde yenilenmesi ve bileşik etkisi dikkate alınarak hesaplanan yıllıklandırılmış getiridir.",
  },
  {
    question: "Mevduat karşılaştırırken sadece aylık kazanca bakmak doğru mu?",
    answer:
      "Hayır. Vade sonu net kazanç, yenileme oranı, likidite ve reel getiri de incelenmelidir.",
  },
  {
    question: "Faiz oranları gün içinde değişebilir mi?",
    answer:
      "Evet. Bankalar piyasa koşullarına ve kampanyalara göre oranları gün içinde güncelleyebilir.",
  },
  {
    question: "Şube ve dijital kanal oranları farklı olabilir mi?",
    answer:
      "Evet. Mobil, internet, çağrı merkezi ve şube kanallarında farklı oranlar uygulanabilir.",
  },
  {
    question: "Yeni para şartı nedir?",
    answer:
      "Bankaya belirli bir tarihten sonra gelen veya mevcut bakiyenin üzerindeki tutarın kampanya kapsamına alınmasıdır.",
  },
  {
    question: "Mevduat faiz karşılaştırma aracı ne gösterir?",
    answer:
      "Ana para, vade ve oranlara göre brüt faiz, stopaj, net kazanç ve vade sonu toplam bakiyeyi karşılaştırır.",
  },
  {
    question: "Hesaplama sonucu kesin midir?",
    answer:
      "Hayır. Sonuç tahminidir; kesin oran ve koşullar işlem anında banka tarafından belirlenir.",
  },
  {
      ...
      <main className="min-h-screen bg-slate-50">
        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[280px_minmax(0,1fr)] lg:px-8 lg:py-14">
          ...
          <article className="min-w-0 space-y-8">
            <ArticleSection
              id="faiz-orani-karsilastirma-nedir"
              eyebrow="Temel bilgi"
              title="Mevduat faiz oranı karşılaştırma nedir?"
            ...
            <ArticleSection
              id="karsilastirmada-kullanilan-veriler"
              eyebrow="Formül"
            ...
            >
              <div className="space-y-4">
                ...
                />
                <MistakeCard
                  title="Vade ve gün esasını göz ardı etmek"
