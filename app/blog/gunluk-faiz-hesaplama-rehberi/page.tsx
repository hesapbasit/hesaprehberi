...
const pageTitle = "Günlük Faiz Hesaplama Rehberi";
const pageDescription =
  "Günlük faiz nasıl hesaplanır? 360 ve 365 gün esası, mevduat, kredi, gecikme faizi, stopaj ve net günlük kazancı örneklerle öğrenin.";
const canonicalPath = "/blog/gunluk-faiz-hesaplama-rehberi";
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "günlük faiz formülü",
    "1 günlük faiz hesaplama",
    "mevduat günlük faiz",
    "kredi günlük faiz",
    "gecikme faizi günlük hesaplama",
    "360 gün faiz hesabı",
    "365 gün faiz hesabı",
    "günlük net faiz",
    "günlük brüt faiz",
    "günlük faiz oranı",
    "stopaj sonrası günlük faiz",
...
const tableOfContents = [
  { id: "gunluk-faiz-nedir", label: "Günlük faiz nedir?" },
  { id: "hesaplamada-kullanilan-veriler", label: "Hesaplamada kullanılan veriler" },
  { id: "temel-formul", label: "Günlük faiz formülü" },
  { id: "yillik-orandan-gunluge", label: "Yıllık orandan günlük orana geçiş" },
  { id: "gun-esasi", label: "360 ve 365 gün esası" },
  { id: "ornek-hesaplama", label: "Adım adım örnek hesaplama" },
  { id: "mevduat-gunluk-faiz", label: "Mevduatta günlük faiz" },
  { id: "kredi-gunluk-faiz", label: "Kredide günlük faiz" },
  { id: "gecikme-faizi", label: "Gecikme faizinin günlük hesabı" },
  { id: "brut-net-stopaj", label: "Brüt, net faiz ve stopaj" },
  { id: "bilesik-gunluk-faiz", label: "Günlük bileşik faiz" },
  { id: "oran-karsilastirma", label: "Oran karşılaştırması" },
  { id: "banka-farki", label: "Banka sonucuyla fark neden olur?" },
...
const faqItems = [
  {
    question: "Günlük faiz nedir?",
    answer:
      "Günlük faiz, bir ana paranın yalnızca bir gün için ürettiği faiz tutarıdır. Genellikle yıllık faiz oranının bankanın kullandığı gün esasına bölünmesiyle hesaplanır.",
  },
  {
    question: "Günlük faiz nasıl hesaplanır?",
    answer:
      "Ana para yıllık faiz oranıyla ve gün sayısıyla çarpılır; sonuç 100 ile gün esasının çarpımına bölünür. Net kazanç için stopaj veya ilgili vergiler düşülür.",
  },
  {
    question: "Yıllık faiz oranı günlük orana nasıl çevrilir?",
    answer:
      "Yıllık yüzde oran 360 veya 365'e bölünür. Hangi paydanın kullanılacağı ürün sözleşmesine ve bankanın hesaplama yöntemine bağlıdır.",
  },
  {
    question: "360 ve 365 gün esası arasındaki fark nedir?",
    answer:
      "Aynı yıllık oran ve ana parada 360 gün esası daha yüksek günlük oran üretir. Bu nedenle küçük de olsa günlük kazanç farkı oluşur.",
  },
  {
    question: "1 günlük mevduat faizi nasıl hesaplanır?",
    answer:
      "Ana para ile yıllık brüt oran çarpılır ve gün esasına bölünür. Brüt faizden stopaj çıkarıldığında bir günlük net mevduat kazancı bulunur.",
  },
  {
    question: "Günlük faiz oranı yüzde olarak nasıl bulunur?",
    answer:
      "Yıllık nominal oran 360 veya 365'e bölünür. Örneğin yıllık yüzde 36 oran, 360 gün esasında günlük yaklaşık yüzde 0,10'dur.",
  },
  {
    question: "Günlük net faiz nedir?",
    answer:
      "Brüt günlük faizden stopaj ve varsa diğer kesintiler çıkarıldıktan sonra hesaba kalan tutardır.",
  },
  {
    question: "Günlük faiz hesabında stopaj nasıl uygulanır?",
    answer:
      "Stopaj doğrudan ana para üzerinden değil, hesaplanan brüt faiz kazancı üzerinden uygulanır.",
  },
  {
    question: "Kredi günlük faizi nasıl hesaplanır?",
    answer:
      "Kalan borç bakiyesi günlük faiz oranıyla ve faiz işletilen gün sayısıyla çarpılır. Vergi ve masraflar kredi türüne göre ayrıca eklenebilir.",
  },
  {
    question: "Gecikme faizi günlük hesaplanabilir mi?",
    answer:
      "Evet. Gecikmiş borç tutarı, geçerli gecikme oranı ve gecikme gün sayısı kullanılır. Sözleşmedeki üst sınırlar ve vergi uygulamaları kontrol edilmelidir.",
  },
  {
    question: "Günlük faiz hafta sonu işler mi?",
    answer:
      "Ürüne göre değişir. Bazı hesaplarda takvim günü, bazılarında iş günü ve valör esasları dikkate alınır. Kesin yöntem sözleşmede yer alır.",
  },
  {
    question: "Valör tarihi günlük faizi etkiler mi?",
    answer:
      "Evet. Paranın faiz kazanmaya başladığı tarih valör tarihidir. İşleme aynı gün yerine sonraki iş günü valör uygulanması kazanç gününü azaltabilir.",
  },
  {
    question: "Günlük bileşik faiz nedir?",
    answer:
      "Her gün oluşan net faizin ana paraya eklenip ertesi gün daha yüksek bakiye üzerinden faiz üretmesidir.",
  },
  {
    question: "Basit günlük faiz ile bileşik günlük faiz arasındaki fark nedir?",
    answer:
      "Basit yöntemde her gün başlangıç ana parası kullanılır. Bileşik yöntemde önceki günlerin faizi de yeni hesaplamaya katılır.",
  },
  {
    question: "Bankanın sonucu neden hesaplama aracından farklı çıkabilir?",
    answer:
      "Gün esası, valör, yuvarlama, stopaj, tatil günü, oran değişimi ve ürünün özel kuralları farklı sonuç oluşturabilir.",
  },
  {
    question: "Günlük faiz hesaplamasında kaç ondalık kullanılmalı?",
    answer:
      "Ara hesaplarda mümkün olduğunca fazla ondalık korunmalı, yalnızca sonuç ekranında kuruş düzeyinde yuvarlama yapılmalıdır.",
  },
  {
    question: "Günlük faiz hesabı yatırım tavsiyesi midir?",
    answer:
      "Hayır. Hesaplama yalnızca matematiksel tahmin sunar; banka veya ürün seçimi için tavsiye niteliği taşımaz.",
  },
  {
    question: "Günlük faiz hesaplama aracı ne işe yarar?",
    answer:
      "Ana para, yıllık oran, gün sayısı, gün esası ve stopaj bilgileriyle brüt ve net günlük kazancı hızlıca gösterir.",
  },
];
...
export default function GunlukFaizHesaplamaRehberiPage() {
  return (
    <>
      <script
      ...
      <main className="min-h-screen bg-slate-50">
        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[280px_minmax(0,1fr)] lg:px-8 lg:py-14">
          ...
          <article className="min-w-0 space-y-8">
            <ArticleSection
              id="gunluk-faiz-nedir"
              eyebrow="Temel bilgi"
              title="Günlük faiz nedir?"
            ...
            <ArticleSection
              ...
              eyebrow="Girdiler"
              title="Günlük faiz hesaplanırken hangi bilgiler kullanılır?"
            ...
            <ArticleSection
              id="temel-formul"
              eyebrow="Formül"
              title="Temel günlük faiz hesaplama formülü"
            ...
            <ArticleSection
              id="yillik-orandan-gunluge"
              eyebrow="Kazanç türleri"
              title="Yıllık faiz oranı günlük orana nasıl çevrilir?"
            ...
            <ArticleSection
              ...
              title="Brüt faiz, net faiz ve stopaj ilişkisi"
            ...
            <ArticleSection
              id="ornek-hesaplama"
              eyebrow="Uygulama"
              title="Günlük faiz adım adım nasıl hesaplanır?"
            ...
            <ArticleSection
              id="mevduat-gunluk-faiz"
              eyebrow="Vade analizi"
              title="Mevduatta günlük faiz nasıl hesaplanır?"
            ...
            <ArticleSection
              ...
              title="Günlük faiz oranları nasıl karşılaştırılır?"
            ...
            <ArticleSection
              id="kredi-gunluk-faiz"
              eyebrow="Yıllıklaştırma"
              title="Kredilerde günlük faiz nasıl hesaplanır?"
              icon={<TrendingUp className="h-6 w-6" />}
            >
              <p>
            ...
            <ArticleSection
              ...
              title="Gecikme faizinin günlük hesabı"
              icon={<RefreshCw className="h-6 w-6" />}
            >
              <p>
            ...
            <ArticleSection
              id="bilesik-gunluk-faiz"
              eyebrow="Satın alma gücü"
              title="Günlük bileşik faiz nasıl hesaplanır?"
              icon={<Scale className="h-6 w-6" />}
            >
              <p>
            ...
            <ArticleSection
              ...
              title="Banka sonucu neden farklı çıkabilir?"
            ...
            <ArticleSection
              ...
              title="Günlük faiz hesaplanırken sık yapılan hatalar"
            ...
            >
              <div className="space-y-4">
                ...
                />
                <MistakeCard
                  title="360 ve 365 gün esasını göz ardı etmek"
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <h2 className="mt-2 text-3xl font-black tracking-tight text-slate-950">
                    Günlük faiz hakkında sık sorulan sorular
                  </h2>
                </div>
              </div>
