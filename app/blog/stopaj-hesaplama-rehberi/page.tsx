...
const pageTitle = "Gecelik Mevduat Faizi Hesaplama Rehberi";
const pageDescription =
  "Stopaj nasıl hesaplanır? Brüt ve net kazanç, mevduat stopajı, ücret ve kira stopajı, oran karşılaştırmaları ve örnek tablolarla öğrenin.";
const canonicalPath = "/blog/stopaj-hesaplama-rehberi";
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "stopaj sonrası net tutar",
    "stopajlı ödeme hesaplama",
  ],
  alternates: {
...
const tableOfContents = [
  ...
  { id: "nasil-calisir", label: "Stopaj nasıl çalışır?" },
  { id: "temel-formul", label: "Stopaj hesaplama formülü" },
  { id: "brutten-nete", label: "Brütten nete hesaplama" },
  { id: "netten-brute", label: "Netten brüte hesaplama" },
  { id: "ornek-hesaplama", label: "Adım adım örnek hesaplama" },
  { id: "mevduat-stopaji", label: "Mevduat stopajı" },
  { id: "kira-stopaji", label: "Kira stopajı" },
  { id: "ucret-stopaji", label: "Ücret ve serbest meslek stopajı" },
  { id: "oran-karsilastirma", label: "Stopaj oranı karşılaştırması" },
  { id: "istisna-ve-muafiyet", label: "İstisna ve muafiyetler" },
  { id: "beyan-ve-odeme", label: "Beyan ve ödeme süreci" },
  { id: "sonuc-farki", label: "Sonuç neden farklı çıkabilir?" },
...
const faqItems = [
  {
    ...
    answer:
      "Stopaj, ödeme yapılırken verginin kaynağında kesilmesi yöntemidir. Kesintiyi yapan taraf, vergiyi ilgili kişi veya kurum adına vergi idaresine aktarır.",
  },
  {
    question: "Stopaj nasıl hesaplanır?",
    answer:
      "Brüt ödeme tutarı geçerli stopaj oranıyla çarpılır. Bulunan tutar brütten düşüldüğünde net ödeme elde edilir.",
  },
  {
    question: "Stopaj formülü nedir?",
    answer:
      "Stopaj tutarı = brüt tutar × stopaj oranı; net tutar = brüt tutar − stopaj tutarı formülüyle hesaplanır.",
  },
  {
    question: "Brüt tutardan net tutar nasıl bulunur?",
    answer:
      "Brüt tutar üzerinden hesaplanan stopaj kesilir. Başka vergi veya kesintiler varsa onlar da ayrıca düşülür.",
  },
  {
    question: "Net tutardan brüt tutar nasıl bulunur?",
    answer:
      "Net tutar, bir eksi stopaj oranına bölünür. Başka kesintiler varsa tek oranlı formül yeterli olmayabilir.",
  },
  {
    question: "Mevduat stopajı nasıl hesaplanır?",
    answer:
      "Ana para üzerinden değil, elde edilen brüt faiz kazancı üzerinden hesaplanır. Net faiz, brüt faizden stopajın çıkarılmasıyla bulunur.",
  },
  {
    question: "Kira stopajı nasıl hesaplanır?",
    answer:
      "Stopaja tabi işyeri kiralarında brüt kira tutarı üzerinden geçerli oran uygulanır. Sözleşmenin net veya brüt düzenlenmesi sonucu etkiler.",
  },
  {
    question: "Ücret stopajı nedir?",
    answer:
      "İşverenin ücret ödemesi sırasında gelir vergisini kaynağında kesmesidir. Matrah, tarife ve diğer yasal kesintiler birlikte değerlendirilir.",
  },
  {
    question: "Serbest meslek stopajı nasıl uygulanır?",
    answer:
      "Stopaja tabi serbest meslek ödemelerinde brüt hizmet bedeli üzerinden geçerli oran kesilir. KDV ve diğer unsurlar ayrı değerlendirilebilir.",
  },
  {
    question: "Stopaj oranı her gelir türünde aynı mıdır?",
    answer:
      "Hayır. Gelirin türü, vade, sözleşme ve yürürlükteki mevzuata göre oran değişebilir.",
  },
  {
    question: "Stopaj ana para üzerinden mi hesaplanır?",
    answer:
      "Mevduat faizinde ana para üzerinden değil, faiz kazancı üzerinden hesaplanır. Diğer gelir türlerinde ise ilgili brüt ödeme matrahı esas alınır.",
  },
  {
    question: "Stopaj nihai vergi midir?",
    answer:
      "Bazı gelirlerde nihai vergi niteliği taşıyabilir, bazılarında ise yıllık beyannamede mahsup edilir. Gelir türüne göre uygulama değişir.",
  },
  {
    question: "Stopaj iade alınabilir mi?",
    answer:
      "Beyanname sonucu kesilen vergi hesaplanan vergiden fazlaysa şartlara bağlı olarak mahsup veya iade gündeme gelebilir.",
  },
  {
    question: "Stopaj hesabı neden farklı çıkabilir?",
    answer:
      "Oran değişikliği, matrah farkı, yuvarlama, istisna, başka kesintiler ve ödemenin net veya brüt tanımlanması sonucu değiştirebilir.",
  },
  {
    question: "Stopaj oranı nereden kontrol edilir?",
    answer:
      "Güncel oranlar resmi mevzuat, vergi idaresi açıklamaları ve ilgili kurumların güncel bilgilendirmelerinden doğrulanmalıdır.",
  },
  {
    question: "Stopaj KDV üzerinden hesaplanır mı?",
    answer:
      "Genel kural olarak stopajın matrahı ile KDV matrahı aynı kavram değildir. İşlemin türüne göre KDV hariç veya farklı bir matrah esas alınabilir.",
  },
  {
    question: "Stopaj hesaplama aracı resmi sonuç verir mi?",
    answer:
      "Hayır. Araç matematiksel tahmin sunar. Kesin işlem için güncel mevzuat ve uzman görüşü dikkate alınmalıdır.",
  },
  {
    question: "Stopaj hesaplama aracı ne işe yarar?",
    answer:
      "Brüt tutar, net tutar ve stopaj oranı arasındaki ilişkiyi hızlıca gösterir; kesinti ve ödeme tutarını karşılaştırmayı kolaylaştırır.",
  },
];
...
export default function StopajHesaplamaRehberiPage() {
  return (
    <>
      <script
        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[280px_minmax(0,1fr)] lg:px-8 lg:py-14">
          ...
          <article className="min-w-0 space-y-8">
            ...
            <ArticleSection
              id="temel-formul"
              eyebrow="Formül"
              title="Temel stopaj hesaplama formülü"
            ...
            <ArticleSection
              ...
              title="Brüt tutardan net tutara nasıl geçilir?"
            ...
            <ArticleSection
              ...
              title="Stopaj oranları nasıl karşılaştırılır?"
            ...
            <ArticleSection
              id="ornek-hesaplama"
              eyebrow="Uygulama"
              title="Stopaj adım adım nasıl hesaplanır?"
            ...
            <ArticleSection
              ...
              title="Mevduat stopajı nasıl hesaplanır?"
            ...
            <ArticleSection
              ...
              title="Kira stopajı nasıl hesaplanır?"
              icon={<TrendingUp className="h-6 w-6" />}
            >
              <p>
            ...
            <ArticleSection
              ...
              title="Ücret ve serbest meslek stopajı"
              icon={<RefreshCw className="h-6 w-6" />}
            >
              <p>
            ...
            <ArticleSection
              id="istisna-ve-muafiyet"
              eyebrow="Satın alma gücü"
              title="Stopaj ile stopaj arasındaki fark"
              icon={<Scale className="h-6 w-6" />}
            >
              <p>
            ...
            <ArticleSection
              ...
              title="Stopaj sonucu neden farklı çıkabilir?"
            ...
            <ArticleSection
              ...
              title="Stopaj hesaplanırken sık yapılan hatalar"
