...
const pageTitle = "Mevduat Faiz Yenileme Rehberi";
...
export const metadata: Metadata = {
  ...
  keywords: [
    "mevduat faiz yenileme",
    "vadeli mevduat yenileme",
    "otomatik mevduat yenileme",
    "vadeli hesap yenileme",
    "mevduat vade sonu yenileme",
    "ana para faiz yenileme",
    "sadece ana para yenileme",
    "mevduat yenileme oranı",
    "vadeli hesap otomatik yenileme",
    "mevduat yenileme hesaplama",
    "vade sonu faiz oranı",
    "mevduat yenileme talimatı",
    "vadeli hesap vade sonu",
    "mevduat bileşik getiri",
  ],
  alternates: {
...
const tableOfContents = [
  { id: "mevduat-yenileme-nedir", label: "Mevduat faiz yenileme nedir?" },
  { id: "yenileme-secenekleri", label: "Yenileme seçenekleri nelerdir?" },
  { id: "otomatik-yenileme", label: "Otomatik yenileme nasıl çalışır?" },
  { id: "yeni-faiz-orani", label: "Yeni faiz oranı nasıl belirlenir?" },
  { id: "ana-para-ve-faiz", label: "Ana para ve faiz birlikte yenilenirse" },
  { id: "sadece-ana-para", label: "Sadece ana para yenilenirse" },
  { id: "stopaj-etkisi", label: "Stopaj yenilemeyi nasıl etkiler?" },
  { id: "ornek-hesaplama", label: "Adım adım yenileme hesabı" },
  { id: "bilesik-getiri", label: "Bileşik getiri etkisi" },
  { id: "oran-degisimi", label: "Faiz oranı değişirse ne olur?" },
  { id: "vade-secimi", label: "Yeni vade nasıl seçilir?" },
  { id: "yenileme-talimatlari", label: "Yenileme talimatları" },
  { id: "kontrol-listesi", label: "Vade sonu kontrol listesi" },
...
const faqItems = [
  {
    ...
    answer:
      "Vadeli hesabın vade sonunda yeni bir faiz oranı ve yeni bir vade ile devam ettirilmesidir.",
  },
  {
    question: "Otomatik yenileme nasıl çalışır?",
    answer:
      "Banka, vade sonunda hesap talimatına göre ana parayı veya ana para ile net faizi yeni vadeye bağlar.",
  },
  {
    question: "Yenileme oranı ilk açılış oranıyla aynı mıdır?",
    answer:
      "Hayır. Yenileme gününde bankanın geçerli oranı uygulanır ve bu oran ilk açılış oranından farklı olabilir.",
  },
  {
    question: "Ana para ve faiz birlikte yenilenebilir mi?",
    answer:
      "Evet. Net faiz ana paraya eklenerek yeni dönemde bileşik getiri oluşturabilir.",
  },
  {
    question: "Sadece ana para yenilenebilir mi?",
    answer:
      "Evet. Faiz vadesiz hesaba aktarılırken yalnızca ana para yeniden vadeye bağlanabilir.",
  },
  {
    question: "Sadece faiz yenilenebilir mi?",
    answer:
      "Bu seçenek standart ürünlerde yaygın değildir; ürün koşullarına göre değişebilir.",
  },
  {
    question: "Yenileme talimatı sonradan değiştirilebilir mi?",
    answer:
      "Çoğu bankada vade bitmeden mobil, internet bankacılığı, çağrı merkezi veya şubeden değiştirilebilir.",
  },
  {
    question: "Vade günü işlem yapılmazsa ne olur?",
    answer:
      "Otomatik yenileme talimatı varsa hesap yeni oranla yenilenir; talimat yoksa tutar vadesiz hesaba aktarılabilir.",
  },
  {
    question: "Yenileme sırasında stopaj yeniden kesilir mi?",
    answer:
      "Her vade döneminde oluşan faiz geliri için geçerli stopaj oranı üzerinden kesinti yapılır.",
  },
  {
    question: "Yenileme bileşik getiri sağlar mı?",
    answer:
      "Net faiz ana paraya eklenerek yenilenirse sonraki dönemde daha yüksek tutar üzerinden faiz kazanılır.",
  },
  {
    question: "Faiz oranı düşerse otomatik yenileme mantıklı mı?",
    answer:
      "Yeni oran alternatiflerden düşükse otomatik yenileme yerine farklı vade veya banka seçenekleri karşılaştırılmalıdır.",
  },
  {
    question: "Faiz oranı yükselirse mevcut hesap etkilenir mi?",
    answer:
      "Mevcut vade genellikle sözleşmedeki oranla devam eder; yüksek oran ancak yeni vadede uygulanır.",
  },
  {
    question: "Yenileme vadesi değiştirilebilir mi?",
    answer:
      "Evet. Bankanın sunduğu vadeler arasından vade sonundan önce veya yenileme sırasında yeni süre seçilebilir.",
  },
  {
    question: "Hoş geldin faizi yenilemede devam eder mi?",
    answer:
      "Çoğu kampanyada hoş geldin oranı belirli süreyle sınırlıdır ve yenilemede standart oran uygulanabilir.",
  },
  {
    question: "Yenileme günü valör kaybı olur mu?",
    answer:
      "Otomatik yenilemede genellikle kesinti olmaz; manuel işlemde saat ve valör kuralları nedeniyle boş gün oluşabilir.",
  },
  {
    question: "Mevduat faiz yenileme aracı ne gösterir?",
    answer:
      "Yeni ana para, yeni faiz oranı, vade, stopaj ve bileşik etkiye göre tahmini net kazancı gösterir.",
  },
  {
    question: "Hesaplama sonucu kesin midir?",
    answer:
      "Hayır. Kesin oran, stopaj ve vade koşulları yenileme gününde banka tarafından belirlenir.",
  },
  {
          ...
          <article className="min-w-0 space-y-8">
            ...
            >
              <div className="space-y-4">
                ...
                />
                <MistakeCard
                  title="Sadece ana para yenilenirsenı göz ardı etmek"
