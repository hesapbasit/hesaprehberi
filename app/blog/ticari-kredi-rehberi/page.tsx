...
const canonicalPath = "/blog/ticari-kredi-rehberi";

export const metadata: Metadata = {
  title: "Ticari Kredi Rehberi",
  description:
    "Ticari kredi nedir, nasıl hesaplanır? İşletme sermayesi, spot kredi, rotatif kredi, taksit, faiz, teminat ve toplam maliyeti örneklerle öğrenin.",
  alternates: {
    canonical: canonicalPath,
  },
  openGraph: {
    title: "Ticari Kredi Rehberi | HesapRehberi",
    description:
      "İşletmeler için ticari kredi türleri, faiz hesabı, ödeme planı, teminat, nakit akışı ve toplam maliyet rehberi.",
    url: canonicalPath,
    type: "article",
  },
  twitter: {
    ...
    title: "Ticari Kredi Rehberi | HesapRehberi",
    description:
      "Ticari kredi seçeneklerini faiz, vade, taksit, teminat, vergi ve toplam maliyet üzerinden değerlendirin.",
  },
};

const tableOfContents = [
  ["ticari-kredi-nedir", "Ticari kredi nedir?"],
  ["kimler-kullanabilir", "Kimler ticari kredi kullanabilir?"],
  ["kredi-turleri", "Ticari kredi türleri"],
  ["faiz-hesabi", "Ticari kredi faizi nasıl hesaplanır?"],
  ["taksit-hesabi", "Aylık taksit nasıl hesaplanır?"],
  ["spot-kredi", "Spot kredi"],
  ["rotatif-kredi", "Rotatif kredi"],
  ["iskonto-kredisi", "İskonto ve iştira kredileri"],
  ["teminat", "Teminat ve kefalet şartları"],
  ["masraflar", "Masraf, vergi ve fonlar"],
  ["nakit-akisi", "Nakit akışına uygun vade seçimi"],
  ["ornek-hesaplama", "Adım adım örnek hesaplama"],
  ["banka-degerlendirmesi", "Bankalar işletmeyi nasıl değerlendirir?"],
...
const rateComparisonRows = [
  {
    rate: "Spot kredi",
    installment: "Vade sonunda",
    total: "Düşük operasyon",
  },
  {
    rate: "Taksitli ticari kredi",
    installment: "Aylık sabit",
    total: "Düzenli ödeme",
  },
  {
    rate: "Rotatif kredi",
    installment: "Esnek kullanım",
    total: "Değişken maliyet",
  },
];
...
const termComparisonRows = [
  {
    term: "12 ay",
    installment: "102.400 TL",
    total: "1.228.800 TL",
    interest: "228.800 TL",
  },
  {
    term: "24 ay",
    installment: "61.750 TL",
    total: "1.482.000 TL",
    interest: "482.000 TL",
  },
  {
    term: "36 ay",
    installment: "49.300 TL",
    total: "1.774.800 TL",
    interest: "774.800 TL",
  },
];
...
const faqItems = [
  ...
  {
    question: "Ticari kredi ile ihtiyaç kredisi arasındaki fark nedir?",
    answer:
  ...
  {
    question: "Ticari kredi hesabı kesin banka teklifi verir mi?",
    answer:
      "Hayır. Hesaplama tahminidir; kesin oran ve maliyet bankanın işletmeye özel teklifinde yer alır.",
  },
  {
    question: "Ticari kredi hesaplama aracı ne işe yarar?",
    answer:
      ...
      <div className="mx-auto max-w-5xl px-6">
        ...
        <article className="rounded-3xl bg-white p-8 shadow-sm md:p-12">
          ...
          <div className="mt-12 space-y-14">
            <section id="ticari-kredi-nedir" className="scroll-mt-24">
            ...
            <section id="spot-kredi" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-slate-900">
            ...
            <section id="rotatif-kredi" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-slate-900">
            ...
            <section className="rounded-3xl bg-gradient-to-br from-blue-600 to-indigo-700 p-8 text-white md:p-10">
              ...
              >
                Ticari Kredi Hesaplama Aracını Aç
