...
const canonicalPath = "/blog/ihtiyac-kredisi-hesaplama-rehberi";

export const metadata: Metadata = {
  title: "İhtiyaç Kredisi Hesaplama Rehberi",
  description:
    "İhtiyaç kredisi taksiti, toplam geri ödeme, faiz maliyeti, vade karşılaştırması, sigorta ve ek masrafların nasıl hesaplandığını örneklerle öğrenin.",
  alternates: {
    canonical: canonicalPath,
  },
  openGraph: {
    title: "İhtiyaç Kredisi Hesaplama Rehberi | HesapRehberi",
    description:
      "İhtiyaç kredisi aylık taksit formülü, örnek ödeme tabloları, toplam maliyet, erken ödeme ve yapılandırma rehberi.",
    url: canonicalPath,
    type: "article",
  },
};
...
const tableOfContents = [
  ["ihtiyac-kredisi-nedir", "İhtiyaç kredisi nedir?"],
  ["ihtiyac-kredisi-nasil-calisir", "İhtiyaç kredisi nasıl çalışır?"],
  ["ihtiyac-kredisi-hesaplama", "İhtiyaç kredisi nasıl hesaplanır?"],
  ["aylik-taksit-formulu", "Aylık taksit formülü"],
  ["faiz-orani-etkisi", "Faiz oranının taksite etkisi"],
  ["vade-karsilastirma", "12, 24 ve 36 ay karşılaştırması"],
  ["toplam-geri-odeme", "Toplam geri ödeme nasıl bulunur?"],
  ["masraf-ve-sigorta", "Masraf ve sigorta maliyetleri"],
  ["kredi-notu", "Kredi notu ve gelir etkisi"],
  ...
  ["butce-planlama", "Sağlıklı bütçe planlaması"],
...
const faqItems = [
  ...
  {
    question: "İhtiyaç kredisi faiz oranı neden kişiden kişiye değişir?",
    answer:
  ...
  {
    question: "İhtiyaç kredisi için gelir belgesi gerekir mi?",
    answer:
  ...
  {
    question: "Kredi notu düşükse ihtiyaç kredisi alınabilir mi?",
    answer:
  ...
  {
    question: "İhtiyaç kredisi erken kapatılabilir mi?",
    answer:
  ...
  {
    question: "Hayat sigortası zorunlu mu?",
    answer:
  ...
  {
    question: "Kredi tahsis ücreti nedir?",
    answer:
  ...
  {
    question: "Kredi başvurusu kredi notunu etkiler mi?",
    answer:
  ...
  {
    question: "Aylık taksit gelirin ne kadarını geçmemeli?",
    answer:
  ...
  {
    question: "İhtiyaç kredisi hesaplama aracı kesin banka teklifi verir mi?",
    answer:
  ...
  {
    question: "Faiz oranındaki küçük fark önemli midir?",
    answer:
  ...
  {
    question: "En ucuz ihtiyaç kredisi nasıl bulunur?",
    answer:
      ...
      <div className="mx-auto max-w-5xl px-6">
        <Breadcrumb
          items={[
            ...
            { label: "İhtiyaç Kredisi Hesaplama Rehberi" },
          ]}
        />
        ...
        <article className="rounded-3xl bg-white p-8 shadow-sm md:p-12">
          ...
          <div className="mt-12 space-y-14">
            <section id="ihtiyac-kredisi-nedir" className="scroll-mt-24">
            ...
            <section id="ihtiyac-kredisi-nasil-calisir" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-slate-900">
            ...
            <section id="ihtiyac-kredisi-hesaplama" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-slate-900">
            ...
            <section id="kredi-notu" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-slate-900">
            ...
            <section className="rounded-3xl bg-gradient-to-br from-blue-600 to-indigo-700 p-8 text-white md:p-10">
              ...
              >
                İhtiyaç Kredisi Hesaplama Aracını Aç
