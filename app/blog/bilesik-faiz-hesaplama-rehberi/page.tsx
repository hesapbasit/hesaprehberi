...
const pageTitle = "Bileşik Bileşik Faiz Hesaplama Rehberi";
const pageDescription =
  "Bileşik faiz nasıl hesaplanır? Formülü, basit faiz farkı, aylık ve yıllık bileşikleşme, efektif oran, stopaj ve örnek tablolarla öğrenin.";
const canonicalPath = "/blog/bilesik-faiz-hesaplama-rehberi";
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "yıllık bileşik faiz",
    "günlük bileşik faiz",
    "basit faiz bileşik faiz farkı",
    "efektif faiz oranı",
    "nominal faiz oranı",
    "mevduat yenileme",
    "bileşik getiri",
    "72 kuralı",
    "stopaj sonrası bileşik faiz",
    "reel bileşik getiri",
  ],
  alternates: {
...
const tableOfContents = [
  { id: "faiz-nedir", label: "Bileşik faiz nedir?" },
  { id: "faiz-nasil-hesaplanir", label: "Bileşik faiz nasıl hesaplanır?" },
...
const faqItems = [
  ...
  {
    question: "Bileşik faiz hesaplamasında yüzde oranı nasıl kullanılır?",
    answer:
  ...
  {
    question: "Bileşik faiz hesaplama sonucu neden bankadan farklı çıkabilir?",
    answer:
  ...
  {
    question: "Bileşik faiz hesaplama aracı yatırım tavsiyesi verir mi?",
    answer:
...
export default function BilesikFaizHesaplamaRehberiPage() {
  return (
    <>
      <script
      ...
      <main className="min-h-screen bg-slate-50">
        <section className="border-b border-slate-200 bg-white">
          <div className="mx-auto max-w-7xl px-4 py-5 sm:px-6 lg:px-8">
            <Breadcrumb
              items={[{ label: "Blog", href: "/blog" }, { label: pageTitle }]}
            />
          </div>
        </section>
            ...
            <div className="grid items-center gap-12 lg:grid-cols-[minmax(0,1fr)_380px]">
              <div>
                <div className="inline-flex items-center gap-2 rounded-full border border-blue-300/30 bg-white/10 px-4 py-2 text-sm font-semibold text-blue-100 backdrop-blur">
                  ...
                  Bileşik büyümenin kapsamlı anlatımı
                </div>
                ...
                <p className="mt-6 max-w-3xl text-base leading-8 text-blue-100 sm:text-lg">
                  Faizin her dönemde ana paraya eklenerek nasıl büyüdüğünü;
                  bileşikleşme sıklığı, efektif oran, stopaj ve enflasyon
                  etkisiyle birlikte örnekler üzerinden öğrenin.
                </p>

                <div className="mt-8 flex flex-wrap gap-3">
                  <HeroPill text="Bileşik faiz formülü" />
                  <HeroPill text="Aylık ve yıllık örnekler" />
                  <HeroPill text="Efektif getiri tabloları" />
              ...
              <div className="rounded-[30px] border border-white/15 bg-white/10 p-7 backdrop-blur-xl">
                ...
                <h2 className="mt-6 text-2xl font-black text-white">
                  Bileşik getiriyi hesaplayın
                </h2>

                <p className="mt-3 text-sm leading-7 text-blue-100">
                  Ana para, faiz oranı, süre ve bileşikleşme sıklığını girerek
                  gelecekteki toplam tutarı saniyeler içinde hesaplayın.
                </p>
            ...
            <article className="min-w-0 space-y-10">
                ...
                <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    ...
                    <p className="mt-2 text-sm leading-7 text-slate-600">
                      Bu içerik bileşik faiz mantığını öğretmek, farklı
                      bileşikleşme sıklıklarını karşılaştırmak ve uzun vadeli
                      büyümeyi doğru yorumlamanıza yardım etmek için
                      hazırlanmıştır.
                    </p>
                  </div>
              ...
              >
                ...
                <FormulaBox>
                  ...
                  <p className="mt-3">Toplam tutar = Ana para + Faiz tutarı</p>
                </FormulaBox>
              ...
              >
                ...
                <p>
                  Aynı yatırım iki yıl basit faizle devam ederse her yıl 30.000
                  TL faiz oluşur ve iki yıllık toplam faiz 60.000 TL olur.
                  İkinci yılda ilk yılın faizi yeni faiz üretmez.
                </p>
              </ContentSection>
                      ...
                      <tbody className="divide-y divide-slate-200 bg-white">
                        ...
                        <TableRow
                          values={[
                            "Yıllık",
                            "Yıl veya gün oranı",
                            "Mevduat ve ticari ürünler",
                            "Nominal/efektif farkı",
                          ]}
                        />
                      </tbody>
                    </table>
                      ...
                      <tbody className="divide-y divide-slate-200 bg-white">
                        <TableRow
                          values={[
                            "Basit faiz",
                            "İlk ana para",
                            "Kısa dönem örnekleri",
                            "Faizler ana paraya eklenmez",
                          ]}
                        />
                        <TableRow
                          values={[
                            ...
                            "Güncel bakiye",
                            "Uzun vadeli birikim",
                            "Faiz yeniden faiz kazanır",
                          ]}
                        />
                        <TableRow
                          values={[
                            "Mevduat faizi",
                            "Ana para ve vade günü",
                            "Vadeli hesap",
              ...
              >
                <p>
                  Faiz kazancının TL olarak artması her zaman satın alma gücünün
                  arttığı anlamına gelmez. Net getiri enflasyonun altında
                  kalırsa nominal kazanç oluşmasına rağmen reel kayıp
                  yaşanabilir.
                </p>

                <FormulaBox>
                  <p>Reel getiri = [(1 + net getiri) ÷ (1 + enflasyon)] − 1</p>
                </FormulaBox>
              ...
              <ContentSection
                ...
                title="Bileşik faiz hesaplamasında dikkat edilmesi gerekenler"
              >
                <div className="grid gap-4 sm:grid-cols-2">
              ...
              <ContentSection
                ...
                title="Bileşik faiz hesaplamasında sık yapılan hatalar"
              >
        ...
        <section className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-8 lg:pb-20">
          <div className="relative overflow-hidden rounded-[34px] bg-gradient-to-br from-blue-700 via-blue-800 to-indigo-900 px-6 py-10 text-white sm:px-10 sm:py-12 lg:px-14">
            ...
            <div className="relative flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
              ...
              >
                Bileşik faiz hesaplama aracına git
                <ArrowRight className="h-4 w-4" />
              </Link>
            </div>
          </div>
