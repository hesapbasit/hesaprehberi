...
const canonicalPath = "/blog/kredi-yapilandirma-rehberi";

export const metadata: Metadata = {
  title: "Kredi Yapılandırma Rehberi",
  description:
    "Kredi yapılandırma nasıl yapılır? Yeni faiz oranı, vade uzatma, aylık taksit, toplam maliyet ve refinansman hesabını örneklerle öğrenin.",
  alternates: {
    canonical: canonicalPath,
  },
  openGraph: {
    title: "Kredi Yapılandırma Rehberi | HesapRehberi",
    description:
      "İhtiyaç, taşıt ve konut kredilerinde yapılandırma, refinansman, yeni faiz oranı, vade ve toplam maliyet hesabı rehberi.",
    url: canonicalPath,
    type: "article",
  },
  twitter: {
    ...
    title: "Kredi Yapılandırma Rehberi | HesapRehberi",
    description:
      "Mevcut kredi borcunu yeni faiz, yeni vade, masraflar ve toplam geri ödeme üzerinden yeniden yapılandırmayı değerlendirin.",
  },
};

const tableOfContents = [
  ["kredi-yapilandirma-nedir", "Kredi yapılandırma nedir?"],
  ["nasil-calisir", "Yapılandırma nasıl çalışır?"],
  ["hangi-durumlarda", "Hangi durumlarda yapılır?"],
  ["yeni-taksit", "Yeni taksit nasıl hesaplanır?"],
  ["yeni-vade", "Vade uzatmanın etkisi"],
  ["faiz-farki", "Faiz oranı değişiminin etkisi"],
  ["toplam-maliyet", "Toplam maliyet karşılaştırması"],
  ["refinansman", "Refinansman ile farkı"],
  ["ihtiyac-kredisi", "İhtiyaç kredisi yapılandırma"],
  ["tasit-kredisi", "Taşıt kredisi yapılandırma"],
  ["konut-kredisi", "Konut kredisi yapılandırma"],
  ["masraflar", "Masraf ve komisyonlar"],
  ["ornek-hesaplama", "Adım adım örnek hesaplama"],
  ["banka-sureci", "Bankada yapılandırma süreci"],
...
const rateComparisonRows = [
  {
    rate: "Mevcut plan",
    installment: "14.850 TL",
    total: "267.300 TL",
  },
  {
    rate: "24 ay yapılandırma",
    installment: "12.420 TL",
    total: "298.080 TL",
  },
  {
    rate: "36 ay yapılandırma",
    installment: "9.760 TL",
    total: "351.360 TL",
  },
];
...
const termComparisonRows = [
  {
    term: "Kalan anapara",
    installment: "210.000 TL",
    total: "210.000 TL",
    interest: "—",
  },
  {
    term: "Yapılandırma masrafı",
    installment: "2.500 TL",
    total: "212.500 TL",
    interest: "2.500 TL",
  },
  {
    term: "Yeni toplam ödeme",
    installment: "12.420 TL",
    total: "298.080 TL",
    interest: "85.580 TL",
  },
...
const faqItems = [
  ...
  {
    question: "İhtiyaç kredisi yapılandırılabilir mi?",
    answer:
      "Bankanın onayı, gelir durumu ve kredi geçmişine bağlı olarak yapılandırılabilir.",
  },
  {
    question: "Taşıt kredisi yapılandırılabilir mi?",
    answer:
      ...
      <div className="mx-auto max-w-5xl px-6">
        <Breadcrumb
          items={[
            ...
            { label: "Kredi Yapılandırma Rehberi" },
          ]}
        />
        ...
        <article className="rounded-3xl bg-white p-8 shadow-sm md:p-12">
          ...
          <div className="mt-12 space-y-14">
            <section id="kredi-yapilandirma-nedir" className="scroll-mt-24">
            ...
            <section id="hangi-durumlarda" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-slate-900">
            ...
            <section id="yeni-taksit" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-slate-900">
            ...
            <section id="yeni-vade" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-slate-900">
            ...
            <section id="faiz-farki" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-slate-900">
            ...
            <section id="toplam-maliyet" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-slate-900">
            ...
            <section className="rounded-3xl bg-gradient-to-br from-blue-600 to-indigo-700 p-8 text-white md:p-10">
              ...
              >
                Yapılandırma Hesaplama Aracını Aç
