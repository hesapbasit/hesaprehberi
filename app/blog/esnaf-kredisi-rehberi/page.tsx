...
const canonicalPath = "/blog/esnaf-kredisi-rehberi";

export const metadata: Metadata = {
  title: "Esnaf Kredisi Rehberi",
  description:
    "Esnaf kredisi nedir, nasıl alınır? Esnaf kefalet kredisi, işletme sermayesi, yatırım, faiz, vade, kefalet ve toplam maliyeti örneklerle öğrenin.",
  alternates: {
    canonical: canonicalPath,
  },
  openGraph: {
    title: "Esnaf Kredisi Rehberi | HesapRehberi",
    description:
      "Esnaf ve sanatkârlar için esnaf kredisi türleri, esnaf kefalet sistemi, başvuru şartları, faiz, vade ve toplam maliyet rehberi.",
    url: canonicalPath,
    type: "article",
  },
  twitter: {
    ...
    title: "Esnaf Kredisi Rehberi | HesapRehberi",
    description:
      "Esnaf kredisi seçeneklerini faiz, vade, taksit, kefalet, kooperatif şartları ve toplam maliyet üzerinden değerlendirin.",
  },
};

const tableOfContents = [
  ["esnaf-kredisi-nedir", "Esnaf kredisi nedir?"],
  ["kimler-kullanabilir", "Kimler esnaf kredisi kullanabilir?"],
  ["kredi-turleri", "Esnaf kredisi türleri"],
  ["esnaf-kefalet", "Esnaf kefalet kredisi"],
  ["isletme-sermayesi", "Esnaf kefalet kredisi"],
  ["yatirim-kredisi", "Yatırım ve işyeri kredileri"],
  ["faiz-hesabi", "Esnaf kredisi faizi nasıl hesaplanır?"],
  ["taksit-hesabi", "Aylık taksit nasıl hesaplanır?"],
  ["kefalet-ve-teminat", "Kefalet ve teminat şartları"],
  ["masraflar", "Masraf, kesinti ve komisyonlar"],
  ["basvuru-sureci", "Başvuru süreci nasıl işler?"],
  ["ornek-hesaplama", "Adım adım örnek hesaplama"],
  ["degerlendirme", "Başvurular nasıl değerlendirilir?"],
...
const rateComparisonRows = [
  {
    rate: "İşletme kredisi",
    installment: "Kısa / orta vade",
    total: "Nakit ve stok ihtiyacı",
  },
  {
    rate: "Yatırım kredisi",
    installment: "Orta / uzun vade",
    total: "Makine ve büyüme",
  },
  {
    rate: "İşyeri edinme",
    installment: "Uzun vade",
    total: "Dükkân ve işyeri",
  },
];
...
const termComparisonRows = [
  {
    term: "12 ay",
    installment: "61.500 TL",
    total: "738.000 TL",
    interest: "138.000 TL",
  },
  {
    term: "24 ay",
    installment: "37.200 TL",
    total: "892.800 TL",
    interest: "292.800 TL",
  },
  {
    term: "36 ay",
    installment: "29.850 TL",
    total: "1.074.600 TL",
    interest: "474.600 TL",
  },
];
...
const faqItems = [
  ...
  {
    question: "Kimler esnaf kredisi kullanabilir?",
    answer:
      ...
      <div className="mx-auto max-w-5xl px-6">
        ...
        <article className="rounded-3xl bg-white p-8 shadow-sm md:p-12">
          ...
          <div className="mt-12 space-y-14">
            <section id="esnaf-kredisi-nedir" className="scroll-mt-24">
            ...
            <section id="esnaf-kefalet" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-slate-900">
            ...
            <section id="kefalet-ve-teminat" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-slate-900">
            ...
            <section id="basvuru-sureci" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-slate-900">
            ...
            <section id="degerlendirme" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-slate-900">
            ...
            <section className="rounded-3xl bg-gradient-to-br from-blue-600 to-indigo-700 p-8 text-white md:p-10">
              ...
              >
                Esnaf Kredisi Hesaplama Aracını Aç
