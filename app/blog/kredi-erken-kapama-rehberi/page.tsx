...
const canonicalPath = "/blog/kredi-erken-kapama-rehberi";

export const metadata: Metadata = {
  title: "Kredi Erken Kapama Rehberi",
  description:
    "Kredi erken kapama nasıl yapılır? Kalan anapara, faiz indirimi, erken ödeme tazminatı, masraf ve tasarruf hesabını örneklerle öğrenin.",
  alternates: {
    canonical: canonicalPath,
  },
  openGraph: {
    title: "Kredi Erken Kapama Rehberi | HesapRehberi",
    description:
      "İhtiyaç, taşıt ve konut kredilerinde erken kapama tutarını, kalan borcu, faiz avantajını ve olası tazminatı hesaplama rehberi.",
    url: canonicalPath,
    type: "article",
  },
  twitter: {
    ...
    title: "Kredi Erken Kapama Rehberi | HesapRehberi",
    description:
      "Kalan anapara, erken ödeme tazminatı, faiz indirimi ve kapama masraflarıyla kredi erken kapama tutarını değerlendirin.",
  },
};

const tableOfContents = [
  ["kredi-erken-kapama-nedir", "Kredi erken kapama nedir?"],
  ["nasil-calisir", "Erken kapama nasıl çalışır?"],
  ["kapama-tutari", "Kapama tutarı nasıl hesaplanır?"],
  ["kalan-anapara", "Kalan anapara nasıl bulunur?"],
  ["faiz-indirimi", "Gelecek faizlerden ne kadar düşer?"],
  ["erken-odeme-tazminati", "Erken ödeme tazminatı"],
  ["ihtiyac-kredisi", "İhtiyaç kredisi erken kapama"],
  ["tasit-kredisi", "Taşıt kredisi erken kapama"],
  ["konut-kredisi", "Konut kredisi erken kapama"],
  ["ara-odeme", "Ara ödeme ile farkı"],
  ["ornek-hesaplama", "Adım adım örnek hesaplama"],
  ["masraflar", "Masraf ve sigorta iadeleri"],
  ["ne-zaman-avantajli", "Ne zaman avantajlıdır?"],
  ["banka-sureci", "Bankada erken kapama süreci"],
  ["butce-planlama", "Bütçe ve nakit planlaması"],
...
const rateComparisonRows = [
  {
    rate: "6. taksitte kapama",
    installment: "185.400 TL",
    total: "42.600 TL",
  },
  {
    rate: "12. taksitte kapama",
    installment: "151.800 TL",
    total: "31.200 TL",
  },
  {
    rate: "18. taksitte kapama",
    installment: "113.700 TL",
    total: "19.800 TL",
  },
];
...
const termComparisonRows = [
  {
    term: "Kalan anapara",
    installment: "142.500 TL",
    total: "142.500 TL",
    interest: "—",
  },
  {
    term: "İşlemiş faiz",
    installment: "1.240 TL",
    total: "143.740 TL",
    interest: "1.240 TL",
  },
  {
    term: "Tazminat / masraf",
    installment: "1.425 TL",
    total: "145.165 TL",
    interest: "1.425 TL",
  },
];
...
const faqItems = [
  ...
  {
    question: "Erken kapamada faiz indirimi olur mu?",
    answer:
  ...
  {
    question: "Kredi kapandıktan sonra otomatik ödeme talimatları ne olur?",
    answer:
      ...
      <div className="mx-auto max-w-5xl px-6">
        <Breadcrumb
          items={[
            ...
            { label: "Kredi Erken Kapama Rehberi" },
          ]}
        />
        ...
        <article className="rounded-3xl bg-white p-8 shadow-sm md:p-12">
          ...
          <div className="mt-12 space-y-14">
            <section id="kredi-erken-kapama-nedir" className="scroll-mt-24">
            ...
            <section id="kapama-tutari" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-slate-900">
            ...
            <section id="kalan-anapara" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-slate-900">
            ...
            <section id="faiz-indirimi" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-slate-900">
            ...
            <section id="erken-odeme-tazminati" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-slate-900">
            ...
            <section id="ne-zaman-avantajli" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-slate-900">
            ...
            <section id="banka-sureci" className="scroll-mt-24">
              <h2 className="text-3xl font-bold text-slate-900">
            ...
            <section className="rounded-3xl bg-gradient-to-br from-blue-600 to-indigo-700 p-8 text-white md:p-10">
              ...
              >
                Erken Kapama Hesaplama Aracını Aç
