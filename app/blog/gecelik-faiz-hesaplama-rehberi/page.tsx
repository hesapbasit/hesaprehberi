...
const pageTitle = "Gecelik Günlük Faiz Hesaplama Rehberi";
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "gecelik mevduat",
    "1 gecelik faiz",
    "gecelik hesap kazancı",
    "gecelik faiz ile gecelik faiz farkı",
    "gecelik faiz formülü",
    "gecelik brüt faiz",
    "gecelik net faiz",
    "stopaj sonrası gecelik faiz",
    "valörlü gecelik faiz",
    "365 gün gecelik faiz",
    "360 gün gecelik faiz",
    "gecelik getiri hesaplama",
  ],
  alternates: {
...
const tableOfContents = [
  { id: "gecelik-faiz-nedir", label: "Gecelik faiz nedir?" },
  { id: "nasil-calisir", label: "Gecelik faiz nasıl çalışır?" },
  { id: "temel-formul", label: "Gecelik faiz formülü" },
  { id: "yillik-orandan-gecelige", label: "Yıllık orandan gecelik orana geçiş" },
  { id: "gun-esasi", label: "360 ve 365 gün esası" },
  { id: "ornek-hesaplama", label: "Adım adım örnek hesaplama" },
  { id: "mevduat-gecelik-faiz", label: "Mevduatta gecelik faiz" },
  { id: "valorlu-gecelik-faiz", label: "Valörlü gecelik faiz" },
  { id: "hafta-sonu", label: "Hafta sonu ve tatil günleri" },
  { id: "brut-net-stopaj", label: "Brüt, net faiz ve stopaj" },
  { id: "gunluk-gecelik-farki", label: "Günlük ve gecelik faiz farkı" },
...
const faqItems = [
  {
    ...
    answer:
      "Gecelik faiz, paranın bir gece boyunca hesapta tutulması karşılığında elde edilen faiz kazancıdır. Çoğu ürün bu getiriyi yıllık oran üzerinden günlük bazda hesaplar.",
  },
  {
    question: "Gecelik faiz nasıl hesaplanır?",
    answer:
      "Ana para yıllık faiz oranıyla çarpılır ve bankanın kullandığı 360 veya 365 gün esasına bölünür. Net kazanç için stopaj düşülür.",
  },
  {
    question: "Gecelik faiz oranı ile gecelik faiz oranı aynı mıdır?",
    answer:
      "Çoğu durumda hesaplama mantığı aynıdır; ancak ürünün valör, minimum bakiye, iş günü ve otomatik yenileme koşulları sonucu değiştirebilir.",
  },
  {
    question: "1 gecelik faiz ne kadar kazandırır?",
    answer:
      "Kazanç ana para, yıllık oran, gün esası ve stopaj oranına bağlıdır. Aynı oran altında daha yüksek ana para daha yüksek gecelik kazanç üretir.",
  },
  {
    question: "Gecelik faiz hafta sonu işler mi?",
    answer:
      "Ürüne göre değişir. Bazı hesaplarda cuma günü yapılan işlem hafta sonu günlerini kapsayabilir, bazılarında ise farklı valör kuralları uygulanır.",
  },
  {
    question: "Gecelik faiz hesaplamasında 360 mı 365 mi kullanılır?",
    answer:
      "Bankanın ürün koşulu belirleyicidir. Aynı yıllık oran altında 360 gün esası, 365 gün esasına göre biraz daha yüksek gecelik brüt faiz üretir.",
  },
  {
    question: "Gecelik hesapta valör ne demektir?",
    answer:
      "Valör, paranın faiz kazanmaya başladığı tarihtir. Aynı gün valörlü ve ertesi gün valörlü ürünler farklı kazanç oluşturabilir.",
  },
  {
    question: "Gecelik brüt faiz nedir?",
    answer:
      "Vergi veya stopaj kesintisi uygulanmadan önce hesaplanan bir gecelik faiz kazancıdır.",
  },
  {
    question: "Gecelik net faiz nedir?",
    answer:
      "Brüt gecelik faizden stopaj ve varsa diğer kesintiler çıkarıldıktan sonra hesaba kalan tutardır.",
  },
  {
    question: "Stopaj gecelik faize nasıl uygulanır?",
    answer:
      "Stopaj ana para üzerinden değil, hesaplanan brüt gecelik faiz kazancı üzerinden kesilir.",
  },
  {
    question: "Gecelik faiz her gün aynı kalır mı?",
    answer:
      "Faiz oranı değişmiyorsa matematiksel tutar aynı olabilir; ancak bakiye, valör, kampanya koşulu veya oran değişikliği sonucu etkileyebilir.",
  },
  {
    question: "Gecelik faiz bileşik getiri sağlar mı?",
    answer:
      "Net faiz her gün ana paraya eklenip ertesi gün büyüyen bakiye üzerinden hesaplanıyorsa bileşik getiri oluşur.",
  },
  {
    question: "Gecelik faiz hesabında minimum bakiye var mı?",
    answer:
      "Bazı ürünlerde vardır. Faiz uygulanacak alt ve üst bakiye sınırları banka veya ürün koşullarında belirtilir.",
  },
  {
    question: "Gecelik faiz neden vadeli mevduattan farklı olabilir?",
    answer:
      "Likidite, vade, kampanya şartları ve bankanın fiyatlama politikası nedeniyle gecelik hesap oranı vadeli mevduat oranından farklı olabilir.",
  },
  {
    question: "Bankanın gecelik faiz sonucu neden farklı çıkabilir?",
    answer:
      "Valör saati, yuvarlama, gün esası, stopaj, minimum bakiye, hafta sonu ve tatil kuralları farklılık yaratabilir.",
  },
  {
    question: "Gecelik faiz hesabı yatırım tavsiyesi midir?",
    answer:
      "Hayır. Hesaplama yalnızca matematiksel bir tahmindir ve banka veya ürün seçimi için tavsiye niteliği taşımaz.",
  },
  {
    question: "Gecelik faiz hesabına para eklenirse ne olur?",
    answer:
      "Faiz uygulanacak bakiye yükselir; ancak eklenen tutarın hangi valörle faiz kazanmaya başlayacağı ürün koşuluna bağlıdır.",
  },
  {
    question: "Gecelik faiz hesaplama aracı ne işe yarar?",
    answer:
      "Ana para, yıllık oran, gün esası ve stopaj bilgileriyle bir gecelik brüt ve net kazancı hızlıca gösterir.",
  },
];
...
export default function GecelikFaizHesaplamaRehberiPage() {
  return (
    <>
      <script
        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[280px_minmax(0,1fr)] lg:px-8 lg:py-14">
          ...
          <article className="min-w-0 space-y-8">
            ...
            <ArticleSection
              id="nasil-calisir"
              eyebrow="Girdiler"
              title="Gecelik faiz nasıl çalışır?"
            ...
            <ArticleSection
              id="temel-formul"
              eyebrow="Formül"
              title="Temel gecelik faiz hesaplama formülü"
            ...
            <ArticleSection
              id="yillik-orandan-gecelige"
              eyebrow="Kazanç türleri"
              title="Yıllık faiz oranı gecelik orana nasıl çevrilir?"
            ...
            <ArticleSection
              id="ornek-hesaplama"
              eyebrow="Uygulama"
              title="Gecelik faiz adım adım nasıl hesaplanır?"
            ...
            <ArticleSection
              id="mevduat-gecelik-faiz"
              eyebrow="Vade analizi"
              title="Mevduatta gecelik faiz nasıl hesaplanır?"
            ...
            <ArticleSection
              ...
              title="Gecelik faiz oranları nasıl karşılaştırılır?"
            ...
            <ArticleSection
              id="valorlu-gecelik-faiz"
              eyebrow="Yıllıklaştırma"
              title="Valörlü gecelik faiz nasıl hesaplanır?"
              icon={<TrendingUp className="h-6 w-6" />}
            >
              <p>
            ...
            <ArticleSection
              ...
              title="Hafta sonu ve tatil günlerinde gecelik faiz"
              icon={<RefreshCw className="h-6 w-6" />}
            >
              <p>
            ...
            <ArticleSection
              id="gunluk-gecelik-farki"
              eyebrow="Satın alma gücü"
              title="Gecelik faiz ile gecelik faiz arasındaki fark"
              icon={<Scale className="h-6 w-6" />}
            >
              <p>
            ...
            <ArticleSection
              ...
              title="Gecelik faiz hesaplanırken sık yapılan hatalar"
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <h2 className="mt-2 text-3xl font-black tracking-tight text-slate-950">
                    Gecelik faiz hakkında sık sorulan sorular
                  </h2>
                </div>
              </div>
