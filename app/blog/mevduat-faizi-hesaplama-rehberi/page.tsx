...
const pageTitle = "Mevduat Faizi Hesaplama Rehberi";
const pageDescription =
  "Mevduat faizi nasıl hesaplanır? Ana para, yıllık faiz oranı, vade, stopaj, gün esası ve net kazanç ilişkisini ayrıntılı örneklerle öğrenin.";
const canonicalPath = "/blog/mevduat-faizi-hesaplama-rehberi";
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "32 günlük faiz hesaplama",
    "günlük mevduat faizi",
    "aylık mevduat kazancı",
    "vade sonu tutarı",
    "mevduat faiz oranı karşılaştırma",
    "efektif mevduat getirisi",
    "reel mevduat getirisi",
...
const tableOfContents = [
  { id: "mevduat-faizi-nedir", label: "Mevduat faizi nedir?" },
  { id: "hesaplamada-kullanilan-veriler", label: "Hesaplamada kullanılan veriler" },
  { id: "temel-formul", label: "Temel mevduat faizi formülü" },
  { id: "brut-net-faiz", label: "Brüt ve net faiz farkı" },
  { id: "stopaj", label: "Stopajın etkisi" },
  { id: "gun-esasi", label: "360 ve 365 gün esası" },
  { id: "ornek-hesaplama", label: "Adım adım örnek hesaplama" },
  { id: "vadelere-gore", label: "Vadelere göre kazanç" },
  { id: "oran-karsilastirma", label: "Faiz oranlarını karşılaştırma" },
  { id: "efektif-getiri", label: "Efektif yıllık getiri" },
  { id: "yenileme-bilesik", label: "Yenileme ve bileşik etki" },
  { id: "reel-getiri", label: "Enflasyon sonrası reel getiri" },
  { id: "kampanya-kosullari", label: "Kampanya koşulları" },
...
const faqItems = [
  {
    ...
    answer:
      "Mevduat faizi, bankaya yatırılan paranın belirli bir süre bankada tutulması karşılığında elde edilen getiridir. Faiz geliri ana para, yıllık oran, vade süresi ve ürün koşullarına göre değişir.",
  },
  {
    question: "Mevduat faizi nasıl hesaplanır?",
    answer:
      "Ana para ile yıllık brüt faiz oranı çarpılır, vade gün sayısı kadar orantılanır ve bankanın kullandığı gün esasına bölünür. Brüt faizden stopaj düşüldüğünde net kazanç bulunur.",
  },
  {
    question: "Mevduat faiz oranı yıllık mı açıklanır?",
    answer:
      "Bankaların ilan ettiği oranlar çoğunlukla yıllık brüt faiz oranıdır. 32, 46 veya 92 günlük kazanç için bu yıllık oran vade gün sayısına göre orantılanır.",
  },
  {
    question: "Brüt mevduat faizi nedir?",
    answer:
      "Brüt mevduat faizi, vergi kesintisi uygulanmadan önce hesaplanan faiz geliridir. Hesaba geçen tutar brüt değil, stopaj sonrası net faizdir.",
  },
  {
    question: "Net mevduat faizi nedir?",
    answer:
      "Net mevduat faizi, brüt faiz gelirinden yürürlükteki stopaj ve varsa diğer kesintiler çıkarıldıktan sonra tasarruf sahibinin hesabına geçen kazançtır.",
  },
  {
    question: "Stopaj nasıl hesaplanır?",
    answer:
      "Stopaj, brüt faiz kazancı üzerinden uygulanır. Brüt faiz ile ilgili stopaj oranı çarpılarak kesinti bulunur; bu tutar brüt faizden çıkarılır.",
  },
  {
    question: "32 günlük mevduat faizi nasıl hesaplanır?",
    answer:
      "Yıllık brüt faiz oranı 32 günlük süreye orantılanır. Brüt kazanç hesaplandıktan sonra stopaj çıkarılır ve kalan net kazanç ana paraya eklenir.",
  },
  {
    question: "360 ve 365 gün esası arasındaki fark nedir?",
    answer:
      "Faiz formülünün paydasında 360 veya 365 kullanılması dönemsel kazancı değiştirir. Diğer koşullar aynıysa 360 gün esası biraz daha yüksek brüt faiz sonucu verebilir.",
  },
  {
    question: "En yüksek oran her zaman en yüksek kazancı sağlar mı?",
    answer:
      "Hayır. Kampanya limiti, valör tarihi, stopaj, vade günü, yeni müşteri şartı ve vade sonu yenileme oranı gibi ayrıntılar net kazancı değiştirebilir.",
  },
  {
    question: "Mevduat faizi günlük hesaplanabilir mi?",
    answer:
      "Evet. Yıllık brüt faiz oranı gün esasına bölünerek yaklaşık günlük oran elde edilebilir. Kesin banka sonucu için valör ve yuvarlama kuralları dikkate alınmalıdır.",
  },
  {
    question: "Faiz geliri ana paraya eklenirse ne olur?",
    answer:
      "Net faiz ana paraya eklenerek hesap yenilenirse sonraki dönemde daha büyük bir tutar faiz kazanır. Birden fazla yenilemede bileşik getiri etkisi oluşur.",
  },
  {
    question: "Vade sonunda faiz oranı aynı kalır mı?",
    answer:
      "Genellikle hayır. İlk vade için verilen oran vade sonuna kadar geçerli olabilir; yenileme tarihinde bankanın o gün sunduğu oran uygulanır.",
  },
  {
    question: "Mevduat erken bozulursa ne olur?",
    answer:
      "Ürün koşullarına göre faiz tamamen kaybedilebilir, daha düşük oran uygulanabilir veya yalnızca çekilmeyen tutar faiz kazanmaya devam edebilir.",
  },
  {
    question: "Efektif yıllık getiri nedir?",
    answer:
      "Efektif yıllık getiri, kısa vadeli mevduatın yıl içinde aynı koşullarla yenilendiği varsayımında bileşik etkiyi de içeren yıllıklaştırılmış getiri ölçüsüdür.",
  },
  {
    question: "Reel mevduat getirisi nasıl hesaplanır?",
    answer:
      "Net mevduat getirisi enflasyon oranıyla birlikte değerlendirilir. Net getiri enflasyonun üzerindeyse pozitif, altındaysa negatif reel getiri oluşabilir.",
  },
  {
    question: "Bankanın hesapladığı tutar neden farklı çıkabilir?",
    answer:
      "Valör tarihi, gün esası, stopaj oranı, yuvarlama yöntemi, vade bitiş saati ve kampanya kuralları küçük veya anlamlı farklar oluşturabilir.",
  },
  {
    question: "Mevduat faizi hesaplama aracı ne işe yarar?",
    answer:
      "Ana para, oran, vade ve stopaj bilgilerini kullanarak tahmini brüt faiz, vergi kesintisi, net kazanç ve vade sonu tutarını hızlıca gösterir.",
  },
  {
    question: "Bu rehber yatırım tavsiyesi midir?",
    answer:
      "Hayır. Rehber genel bilgilendirme ve hesaplama amacı taşır. Banka veya ürün seçimi kişisel mali durum ve ihtiyaçlara göre değerlendirilmelidir.",
  },
];
