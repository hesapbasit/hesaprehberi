...
const pageTitle = "Mevduat Getiri Hedefi Rehberi";
const pageDescription =
  "Belirli bir mevduat getirisi için gerekli ana para, faiz oranı veya vade nasıl hesaplanır? Brüt-net getiri, stopaj ve hedef kazanç ilişkisini örneklerle öğrenin.";
const canonicalPath = "/blog/mevduat-getiri-hedefi-rehberi";
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "hedef faiz kazancı",
    "mevduat hedef kazanç hesaplama",
    "aylık faiz geliri hedefi",
    "gerekli ana para hesaplama",
    "hedef getiri için faiz oranı",
    "vadeli mevduat hedefi",
    "net faiz hedefi",
    "mevduat kazanç hedefi",
    "faiz geliri planlama",
    "pasif gelir mevduat",
    "stopaj sonrası hedef getiri",
    "mevduat vade hedefi",
    "faiz hedef hesaplama",
  ],
  alternates: {
...
const tableOfContents = [
  { id: "getiri-hedefi-nedir", label: "Mevduat getiri hedefi nedir?" },
  { id: "hedef-turleri", label: "Hangi hedefler hesaplanabilir?" },
  { id: "gerekli-veriler", label: "Hesaplamada gerekli veriler" },
  { id: "gerekli-ana-para", label: "Hedef getiri için gerekli ana para" },
  { id: "gerekli-faiz-orani", label: "Gerekli faiz oranı nasıl bulunur?" },
  { id: "gerekli-vade", label: "Hedef için gerekli vade" },
  { id: "stopaj-etkisi", label: "Stopaj hedefi nasıl etkiler?" },
  { id: "ornek-hesaplama", label: "Adım adım hedef getiri hesabı" },
  { id: "aylik-gelir-hedefi", label: "Aylık faiz geliri hedefi" },
  { id: "farkli-senaryolar", label: "Farklı hedef senaryoları" },
  { id: "bilesik-getiri", label: "Bileşik getiri ile hedefe ulaşmak" },
  { id: "enflasyon-etkisi", label: "Enflasyon ve reel hedef" },
  { id: "kontrol-listesi", label: "Hedef planlama kontrol listesi" },
...
const faqItems = [
  {
    ...
    answer:
      "Belirli bir sürede ulaşılmak istenen net faiz kazancı veya vade sonu toplam bakiyedir.",
  },
  {
    question: "Hedef getiri için gerekli ana para nasıl bulunur?",
    answer:
      "Hedef net kazanç; faiz oranı, vade ve stopaj dikkate alınarak birim getiriye bölünür.",
  },
  {
    question: "Aylık 10.000 TL faiz geliri için ne kadar para gerekir?",
    answer:
      "Gerekli tutar güncel faiz oranına, vade süresine, stopaja ve gün esasına göre değişir; hesaplama aracı tahmini ana parayı gösterir.",
  },
  {
    question: "Hedef getiri brüt mü net mi belirlenmelidir?",
    answer:
      "Gerçek kullanım açısından net hedef belirlemek daha sağlıklıdır; çünkü stopaj sonrası elde kalan tutarı gösterir.",
  },
  {
    question: "Stopaj hedef ana parayı artırır mı?",
    answer:
      "Evet. Net hedefe ulaşmak için vergi kesintisi kadar daha yüksek brüt faiz kazanılması gerekir.",
  },
  {
    question: "Faiz oranı yükselirse gerekli ana para ne olur?",
    answer:
      "Diğer koşullar aynıysa hedef kazanç için gereken ana para azalır.",
  },
  {
    question: "Faiz oranı düşerse hedefe ulaşmak zorlaşır mı?",
    answer:
      "Evet. Aynı ana parayla hedefe ulaşmak için daha uzun vade veya daha yüksek oran gerekir.",
  },
  {
    question: "Vade uzadıkça gerekli ana para azalır mı?",
    answer:
      "Basit varsayımda evet; ancak oran, stopaj ve yeniden yatırım koşulları değişebilir.",
  },
  {
    question: "Hedef getiri hesabında 360 mı 365 gün mü kullanılır?",
    answer:
      "Bankanın ürününde kullanılan gün esası dikkate alınmalıdır; iki yöntem farklı sonuç verebilir.",
  },
  {
    question: "Bileşik faiz hedefe ulaşmayı hızlandırır mı?",
    answer:
      "Net faiz ana paraya eklenerek yeniden değerlendirilirse bileşik etki hedefe ulaşma süresini kısaltabilir.",
  },
  {
    question: "Aylık gelir hedefi ile yıllık getiri hedefi aynı mı?",
    answer:
      "Hayır. Aylık gelir nakit akışını, yıllık hedef ise toplam dönem kazancını ifade eder.",
  },
  {
    question: "Enflasyon hedef kazancı nasıl etkiler?",
    answer:
      "Nominal hedefe ulaşılsa bile satın alma gücü azalabilir; bu nedenle reel getiri ayrıca hesaplanmalıdır.",
  },
  {
    question: "Hedef vade içinde faiz oranı değişirse ne olur?",
    answer:
      "Sabit vadede mevcut oran korunabilir; yenileme dönemlerinde yeni oran hedef planını değiştirir.",
  },
  {
    question: "Hedef hesaplaması düzenli ekleme içerir mi?",
    answer:
      "Standart hesap tek ana para üzerinden çalışabilir; düzenli eklemeler için her katkının süresi ayrıca dikkate alınmalıdır.",
  },
  {
    question: "Mevduat getiri hedefi aracı ne gösterir?",
    answer:
      "Hedef kazanç için gerekli ana parayı, oranı veya vade süresini seçilen senaryoya göre tahmin eder.",
  },
  {
    question: "Hedefe ulaşıldığında ana para çekilmeli mi?",
    answer:
      "Bu karar likidite ihtiyacına, yeni oranlara ve kişisel plana bağlıdır.",
  },
  {
    question: "Hesaplama sonucu kesin midir?",
    answer:
      "Hayır. Sonuç girilen varsayımlara dayanır; kesin getiri banka koşullarına göre değişebilir.",
  },
  {
          ...
          <article className="min-w-0 space-y-8">
            ...
            >
              <div className="space-y-4">
                ...
                />
                <MistakeCard
                  title="Hedef için gerekli vadenı göz ardı etmek"
