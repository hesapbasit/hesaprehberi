      ...
      <div className="mx-auto max-w-4xl px-6">
        ...
        <article className="rounded-3xl bg-white p-8 shadow-sm md:p-12">
          ...
          <div className="mt-6 space-y-6">
            <section>
              ...
              <p className="mt-3 leading-8 text-slate-600">
                İnternet sitesinin temel özelliklerinin çalışması için gerekli
                olan çerezlerdir. Bu çerezler olmadan bazı site özellikleri
            ...
            <section>
              ...
              <p className="mt-3 leading-8 text-slate-600">
                ...
                Analytics gibi bir hizmet kullanılmaya başlandığında bu bölüm
                ayrıca güncellenecektir.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-3 leading-8 text-slate-600">
                ...
                tercihleri için ayrıca çerez yönetim sistemi sunulacaktır.
              </p>
            </section>
          </div>
          ...
          <p className="mt-4 leading-8 text-slate-600">
            ...
            veya belirli internet siteleri için çerez kullanımını
            sınırlandırabilirsiniz. Çerezleri tamamen kapatmanız halinde bazı
            site özellikleri beklenen şekilde çalışmayabilir.
          </p>
          ...
          <p className="mt-4 leading-8 text-slate-600">
            İleride Google Analytics, Google AdSense veya benzeri üçüncü taraf
            hizmetleri kullanılabilir. Bu hizmetler kendi çerezlerini
          ...
          <p className="mt-4 leading-8 text-slate-600">
            ...
            Çerez Politikası güncellenebilir. Güncel metin her zaman bu sayfada
            yayımlanır.
          </p>
