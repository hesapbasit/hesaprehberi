...
const canonicalPath = "/hesaplamalar/mevduat-getiri-hedefi";
...
function getRequiredCalculator(): CalculatorItem {
  ...
  if (!foundCalculator) {
    throw new Error(
      `Mevduat getiri hedefi aracı calculators.ts içinde bulunamadı: ${canonicalPath}`,
    );
  }
...
export const metadata: Metadata = createCalculatorMetadata({
  ...calculator,
  title: "Mevduat Getiri Hedefi | Gerekli Ana Para Hesaplama",
  description:
    "Hedeflediğiniz net mevduat kazancı için gereken ana parayı; faiz oranı, vade süresi, stopaj ve gün esasına göre hesaplayın.",
  path: canonicalPath,
  openGraph: {
    title: "Mevduat Getiri Hedefi | Hedef Kazanç İçin Ana Para",
    description:
      "Aylık veya dönemsel net faiz hedefiniz için yatırmanız gereken tahmini ana parayı bulun; stopaj ve vade etkisini birlikte inceleyin.",
    url: canonicalPath,
    type: "website",
  },
  twitter: {
    ...
    description:
      "Hedeflediğiniz net faiz kazancı için gerekli ana parayı, brüt kazancı, stopajı ve vade sonu toplamını saniyeler içinde görün.",
  },
});

const tableOfContents = [
  { id: "hesaplama-araci", label: "Getiri hedefi hesaplama aracı" },
  { id: "vadeli-mevduat-nedir", label: "Mevduat getiri hedefi nedir?" },
  { id: "nasil-hesaplanir", label: "Hedef getiri nasıl hesaplanır?" },
  { id: "formuller", label: "Getiri hedefi hesaplama formülleri" },
  { id: "vade-karsilastirma", label: "Hedef kazanç ve ana para ilişkisi" },
  { id: "faiz-orani-etkisi", label: "Faiz oranının gerekli ana paraya etkisi" },
  { id: "stopaj-rehberi", label: "Stopajın hedef getiriye etkisi" },
  { id: "gun-esasi", label: "360 ve 365 gün esası" },
  { id: "reel-getiri", label: "Reel getiri karşılaştırması" },
  { id: "banka-vade-teklifleri", label: "Banka faiz tekliflerini değerlendirme" },
  { id: "vade-stratejileri", label: "Aylık ve yıllık gelir hedefleri" },
  { id: "erken-bozma", label: "Erken bozma koşulları" },
  { id: "ornek-senaryolar", label: "Örnek hedef getiri senaryoları" },
...
const targetReturnRows = [
  {
    target: "5.000 TL",
    rate: "%45",
    maturity: "32 gün",
    withholding: "%15",
    requiredPrincipal: "134.192 TL",
    finalAmount: "139.192 TL",
  },
  {
    target: "10.000 TL",
    rate: "%45",
    maturity: "32 gün",
    withholding: "%15",
    requiredPrincipal: "268.382 TL",
    finalAmount: "278.382 TL",
  },
  {
    target: "20.000 TL",
    rate: "%45",
    maturity: "32 gün",
    withholding: "%15",
    requiredPrincipal: "536.765 TL",
    finalAmount: "556.765 TL",
  },
  {
    target: "25.000 TL",
    rate: "%45",
    maturity: "32 gün",
    withholding: "%15",
    requiredPrincipal: "670.956 TL",
    finalAmount: "695.956 TL",
  },
  {
    target: "50.000 TL",
    rate: "%45",
    maturity: "32 gün",
    withholding: "%15",
    requiredPrincipal: "1.341.912 TL",
    finalAmount: "1.391.912 TL",
  },
  {
    target: "100.000 TL",
    rate: "%45",
    maturity: "32 gün",
    withholding: "%15",
    requiredPrincipal: "2.683.824 TL",
    finalAmount: "2.783.824 TL",
  },
];
...
const commonMistakes = [
  ...
  {
    title: "Farklı hedefleri yalnızca oranla karşılaştırmak",
    description:
...
const faqItems = [
  {
    question: "Mevduat getiri hedefi nedir?",
    answer:
  ...
  {
    question: "Mevduat hedefleri ne sıklıkla değişir?",
    answer:
...
const howToStructuredData = {
  "@context": "https://schema.org",
  "@type": "HowTo",
  name: "Mevduat hedef senaryoları nasıl karşılaştırılır?",
  description:
  ...
  step: [
    ...
    },
    {
      ...
      text: "Net faiz sıralamasını, vade sonu tutarlarını ve hedefler arasındaki TL farkını değerlendirin.",
    },
  ],
};
...
const articleStructuredData = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Mevduat Getiri Hedefi Rehberi",
  description:
    "Mevduat hedef senaryolarıni aynı koşullarda karşılaştırma, net getiri, stopaj, vade, gün esası ve banka kampanyalarını değerlendirme hakkında kapsamlı rehber.",
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-16 pt-8 md:pb-24 md:pt-10">
          ...
          <div className="mt-10 grid items-center gap-12 lg:grid-cols-[minmax(0,1fr)_420px]">
            <div>
              ...
              <div className="mt-8">
                <ShareButtons
                  title="Mevduat Getiri Hedefi | HesapRehberi"
            ...
            <aside className="rounded-[2rem] border border-slate-200 bg-white/95 p-7 shadow-2xl shadow-slate-200/70 backdrop-blur">
              ...
              <ul className="mt-6 space-y-4">
                {[
                  ...
                  "Her vadein stopajı",
                  "Net faiz sıralaması",
                  "En yüksek ve düşük hedef farkı",
          ...
          <div className="min-w-0">
            ...
            >
              <SectionHeading
                ...
                description="Mevduat getiri hedefisı, aynı yatırım koşullarında farklı hedeflerin net kazançlarını yan yana gösterir. Sağlıklı sonuç için ana para, vade, stopaj ve gün esası sabit tutulmalıdır."
              />

              <div className="mt-8 grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
                <article className="rounded-[2rem] border border-slate-200 bg-white p-7 shadow-sm md:p-9">
                  <h3 className="text-2xl font-black tracking-tight text-slate-950">
                    Faiz hedeflerini karşılaştırmanın çalışma mantığı
                  </h3>
            ...
            >
              <SectionHeading
                ...
                title="Mevduat hedefleri nasıl karşılaştırılır?"
            ...
            >
              <SectionHeading
                ...
                description="Aşağıdaki formüller her vadein brüt ve net kazancını aynı yöntemle hesaplamanın temelini gösterir. Gün esası, stopaj ve vade bütün hedefler için eşit olmalıdır."
              />
            ...
            >
              <SectionHeading
                ...
                title="Farklı hedef kazançlar için gereken ana para"
                description="Aşağıdaki örneklerde yıllık %45 brüt faiz, 32 gün vade, %15 stopaj ve 365 gün esası kullanılmıştır. Sonuçlar yaklaşık değerlerdir."
              />
                ...
                <div className="overflow-x-auto">
                  <table className="w-full min-w-[900px] text-left">
                    <thead className="bg-slate-950 text-white">
                      <tr>
                        <th className="px-6 py-4 text-sm font-extrabold">Hedef net kazanç</th>
                        ...
                        <th className="px-6 py-4 text-sm font-extrabold">Gerekli ana para</th>
                        <th className="px-6 py-4 text-sm font-extrabold">Vade sonu toplam</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-slate-200">
                      {targetReturnRows.map((row) => (
                        <tr
                          key={row.target}
            ...
            >
              <SectionHeading
                ...
                title="Stopaj getiri hedefisını nasıl etkiler?"
                ...
                <div className="space-y-5">
                  {[
                    ...
                    },
                    {
                      ...
                      text: "Banka hedeflerini yalnızca brüt faiz oranı üzerinden değil, stopaj sonrası net TL kazancı üzerinden karşılaştırın.",
                      icon: Scale,
                    },
                    {
            ...
            >
              <SectionHeading
                ...
                title="Hedeflerde 360 ve 365 gün esası neden önemlidir?"
            ...
            >
              <SectionHeading
                ...
                title="Hedefleri reel getiri açısından karşılaştırma"
            ...
            >
              <SectionHeading
                ...
                title="Banka mevduat hedefleri adil biçimde nasıl karşılaştırılır?"
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-2 leading-7 text-blue-900">
                      ...
                      tutarları farklı hedeflere bölmek, düzenli nakit erişimi ve
            ...
            >
              <SectionHeading
                ...
                title="Farklı tutar ve hedeflerde getiri hedefi senaryoları"
            ...
            >
              <SectionHeading
                ...
                title="Mevduat hedef senaryolarıni karşılaştırırken yapılan hatalar"
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-3 leading-8 text-emerald-900">
                      ...
                      koşulu kullanılmalıdır. Ardından hedefler net faiz kazancı
            ...
            >
              <SectionHeading
                ...
                title="Mevduat getiri hedefisı hakkında merak edilenler"
              ...
              <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
                <div className="max-w-3xl">
                  ...
                  <p className="mt-4 leading-8 text-blue-100">
                    ...
                    mevduat hedeflerini, reel getiriyi ve erken bozma kaybını
