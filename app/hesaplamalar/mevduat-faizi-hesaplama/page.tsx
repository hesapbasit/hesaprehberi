...
const canonicalPath = "/hesaplamalar/mevduat-faizi-hesaplama";
...
export const metadata: Metadata = createCalculatorMetadata({
  ...calculator,
  title: "Mevduat Faizi Hesaplama | Net Faiz ve Vade Sonu",
  description:
    "Mevduat faizi hesaplama aracıyla ana para, yıllık faiz oranı, vade ve stopaj bilgilerine göre brüt faiz, net faiz, net getiri oranı ve vade sonu tutarını hesaplayın.",
  path: canonicalPath,
  openGraph: {
    title: "Mevduat Faizi Hesaplama | Brüt ve Net Getiri",
    description:
      "Ana para, yıllık faiz oranı, vade ve stopaja göre mevduat faiz getirinizi hesaplayın; farklı oran ve vadeleri karşılaştırın.",
    url: canonicalPath,
    type: "website",
  },
  twitter: {
    ...
    description:
      "Mevduat faizi brüt kazanç, stopaj, net faiz ve vade sonu tutarını saniyeler içinde hesaplayın.",
  },
});

const tableOfContents = [
  { id: "hesaplama-araci", label: "Mevduat faizi hesaplama aracı" },
  { id: "vadeli-mevduat-nedir", label: "Mevduat faizi nedir?" },
  { id: "nasil-hesaplanir", label: "Mevduat faizi nasıl hesaplanır?" },
  { id: "formuller", label: "Brüt faiz, stopaj ve net getiri formülleri" },
  { id: "vade-karsilastirma", label: "Vade karşılaştırma tablosu" },
  { id: "faiz-orani-etkisi", label: "Faiz oranının getiriye etkisi" },
  { id: "stopaj-rehberi", label: "Stopajın mevduat getirisine etkisi" },
  { id: "gun-esasi", label: "360 ve 365 gün esası" },
  { id: "reel-getiri", label: "Enflasyon sonrası reel getiri" },
  { id: "teklif-karsilastirma", label: "Banka teklifleri nasıl karşılaştırılır?" },
  { id: "vade-stratejileri", label: "Vade seçimi ve mevduat stratejileri" },
  { id: "erken-bozma", label: "Mevduat faiziı erken bozmak" },
  { id: "ornek-senaryolar", label: "Örnek mevduat senaryoları" },
...
const faqItems = [
  {
    question: "Mevduat faizi nedir?",
    answer:
      "Mevduat faizi, belirli bir süre boyunca bankada tutulan ana paraya önceden belirlenen faiz oranı üzerinden getiri sağlayan mevduat türüdür. Vade dolduğunda ana para ile stopaj sonrası net faiz kazancı hesap sahibine ödenir veya talimata göre yeniden vadeye bağlanır.",
  },
  {
  ...
  {
    question: "Mevduat faizi hesaplama aracında hangi bilgiler gerekir?",
    answer:
  ...
  {
    question: "32 günlük mevduat faizi getirisi nasıl hesaplanır?",
    answer:
  ...
  {
    question: "360 gün ve 365 gün faiz hesabı arasındaki fark nedir?",
    answer:
  ...
  {
    question: "Mevduat faizi erken bozulursa ne olur?",
    answer:
  ...
  {
    question: "Vade sonunda hesap otomatik yenilenir mi?",
    answer:
  ...
  {
    question: "Mevduat faizi enflasyona karşı korur mu?",
    answer:
  ...
  {
    question: "Reel getiri nasıl hesaplanır?",
    answer:
  ...
  {
    question: "Mevduat faizi mı, günlük faiz hesabı mı daha avantajlıdır?",
    answer:
      "Mevduat faizi belirli süre için oranı sabitleyebilir; günlük faiz hesabı ise daha yüksek likidite sunabilir. Avantajlı seçenek faiz oranı, para kullanım planı, erken çekim ihtimali ve yenileme koşullarına bağlıdır.",
  },
  {
    question: "Mevduat faizi ile bileşik faiz aynı şey midir?",
    answer:
      "Tek dönemli mevduat faizi hesabı genellikle basit faiz yaklaşımıyla hesaplanır. Ancak vade sonunda faiz ana paraya eklenerek hesap tekrar tekrar yenilenirse dönemler arasında bileşik getiri etkisi oluşabilir.",
  },
  {
    question: "Hesaplama sonucu banka sonucuyla neden farklı olabilir?",
    answer:
  ...
  {
    question: "Mevduat faizita ana para güvencesi var mı?",
    answer:
  ...
  {
    question: "Vade bölmek mantıklı mı?",
    answer:
...
const howToStructuredData = {
  ...
  description:
    "Ana para, faiz oranı, vade ve stopaj bilgileriyle net mevduat faizi getirisini hesaplama adımları.",
  totalTime: "PT2M",
  step: [
    {
      "@type": "HowToStep",
    ...
    },
    {
      ...
      text: "Bankanın sunduğu yıllık brüt faiz oranını girin.",
    },
    {
      "@type": "HowToStep",
      position: 3,
    ...
    },
    {
      ...
      text: "Brüt faiz, stopaj, net kazanç ve vade sonu toplam tutarı karşılaştırın.",
    },
  ],
};
...
const articleStructuredData = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Mevduat Faizi Hesaplama Rehberi",
  description:
    "Mevduat faizi, stopaj, net getiri, vade seçimi, reel getiri ve banka tekliflerini karşılaştırma hakkında kapsamlı rehber.",
            ...
            <div>
              ...
              <div className="mt-8">
                <ShareButtons
                  ...
                  description="Mevduat faizi brüt faiz, stopaj, net kazanç ve vade sonu tutarını ücretsiz hesaplayın."
                />
              </div>
            </div>
          ...
          <div className="min-w-0">
            ...
            >
              <SectionHeading
                ...
                description="Mevduat faizi, birikimin belirli bir süre boyunca bankada tutulması karşılığında faiz getirisi sağlayan mevduat türüdür. Getiri; ana para, yıllık faiz oranı, vade süresi ve kesintilere göre değişir."
              />

              <div className="mt-8 grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
                <article className="rounded-[2rem] border border-slate-200 bg-white p-7 shadow-sm md:p-9">
                  <h3 className="text-2xl font-black tracking-tight text-slate-950">
                    Mevduat faizinin çalışma mantığı
                  </h3>
            ...
            >
              <SectionHeading
                ...
                title="Brüt faiz, stopaj ve net getiri formülleri"
                description="Aşağıdaki formüller, mevduat faizi hesaplamasının temelini gösterir. Banka uygulamaları gün esası, yuvarlama ve valör nedeniyle küçük farklılıklar oluşturabilir."
              />
            ...
            >
              <SectionHeading
                ...
                title="Farklı vadelerde mevduat getirisi karşılaştırması"
            ...
            >
              <SectionHeading
                ...
                title="Faiz oranının net kazanca etkisi"
            ...
            >
              <SectionHeading
                ...
                title="Stopaj mevduat faizi getirisini nasıl etkiler?"
            ...
            >
              <SectionHeading
                ...
                title="360 gün ve 365 gün faiz hesabı arasındaki fark"
            ...
            >
              <SectionHeading
                ...
                title="Mevduat faiz teklifleri nasıl karşılaştırılır?"
            ...
            >
              <SectionHeading
                ...
                title="Kısa, orta ve uzun vade nasıl seçilir?"
            ...
            >
              <SectionHeading
                ...
                title="Mevduat faizi vade dolmadan bozulursa ne olur?"
            ...
            >
              <SectionHeading
                ...
                title="Farklı amaçlara göre mevduat faizi senaryoları"
            ...
            >
              <SectionHeading
                ...
                title="Mevduat faiz hesaplamasında sık yapılan hatalar"
            ...
            >
              <SectionHeading
                ...
                title="İlgili mevduat ve finans hesaplamaları"
                description="Mevduat faizi kararınızı farklı açılardan değerlendirmek için aşağıdaki hesaplama araçlarını kullanabilirsiniz."
              />
            ...
            >
              <SectionHeading
                ...
                title="Mevduat faizi hakkında merak edilenler"
                description="Mevduat faizi, vade, stopaj, erken bozma ve reel getiri hakkında en sık sorulan soruların yanıtlarını inceleyin."
              />
