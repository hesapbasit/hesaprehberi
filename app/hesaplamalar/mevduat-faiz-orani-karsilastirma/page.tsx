...
const canonicalPath = "/hesaplamalar/mevduat-faiz-orani-karsilastirma";
...
function getRequiredCalculator(): CalculatorItem {
  ...
  if (!foundCalculator) {
    throw new Error(
      `Mevduat faiz oranı karşılaştırma aracı calculators.ts içinde bulunamadı: ${canonicalPath}`,
    );
  }
...
export const metadata: Metadata = createCalculatorMetadata({
  ...calculator,
  title: "Mevduat Faiz Oranı Karşılaştırma | Net Getiri Analizi",
  description:
    "Aynı ana para ve vade için üç farklı mevduat faiz teklifini karşılaştırın; brüt faiz, stopaj, net kazanç, vade sonu tutarı ve teklifler arasındaki TL farkını hesaplayın.",
  path: canonicalPath,
  openGraph: {
    title: "Mevduat Faiz Oranı Karşılaştırma | En İyi Teklifi Bulun",
    description:
      "Üç farklı banka veya kampanya teklifini aynı koşullarda karşılaştırın; en yüksek net faiz getirisini ve teklifler arasındaki kazanç farkını görün.",
    url: canonicalPath,
    type: "website",
  },
  twitter: {
    card: "summary_large_image",
    title: "Mevduat Faiz Oranı Karşılaştırma",
    description:
      "Üç mevduat teklifinin brüt ve net faizini karşılaştırın; en yüksek getiriyi ve faiz farkının TL karşılığını saniyeler içinde görün.",
  },
});

const tableOfContents = [
  { id: "hesaplama-araci", label: "Faiz oranı karşılaştırma aracı" },
  { id: "vadeli-mevduat-nedir", label: "Faiz oranı karşılaştırması nedir?" },
  { id: "nasil-hesaplanir", label: "Teklifler nasıl karşılaştırılır?" },
  { id: "formuller", label: "Karşılaştırma formülleri" },
  { id: "vade-karsilastirma", label: "Vadenin oran farkına etkisi" },
  { id: "faiz-orani-etkisi", label: "Faiz puanının TL karşılığı" },
  { id: "stopaj-rehberi", label: "Stopajın karşılaştırmaya etkisi" },
  { id: "gun-esasi", label: "360 ve 365 gün esası" },
  { id: "reel-getiri", label: "Reel getiri karşılaştırması" },
  { id: "teklif-karsilastirma", label: "Banka tekliflerini değerlendirme" },
  { id: "vade-stratejileri", label: "Vade stratejisi" },
  { id: "erken-bozma", label: "Erken bozma koşulları" },
  { id: "ornek-senaryolar", label: "Örnek karşılaştırmalar" },
...
const faqItems = [
  {
    question: "Mevduat faiz oranı karşılaştırması nedir?",
    answer:
      "Aynı ana para, vade, stopaj ve gün esası kullanılarak farklı bankaların veya kampanyaların yıllık faiz oranlarının brüt ve net getirilerinin yan yana incelenmesidir.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Ana para, vade günü, stopaj oranı ve gün esası aynı tutulmalıdır. Böylece tekliflerin yalnızca faiz oranından kaynaklanan kazanç farkı görülebilir.",
  },
  {
    question: "Araç kaç farklı teklifi karşılaştırır?",
    answer:
      "Hesaplama aracı aynı anda üç farklı mevduat teklifini karşılaştırır ve sonuçları net faiz kazancına göre sıralar.",
  },
  {
  ...
  {
    question: "Stopaj teklif sıralamasını değiştirir mi?",
    answer:
      "Bütün tekliflere aynı stopaj oranı uygulanıyorsa sıralama genellikle değişmez; ancak her teklifin TL cinsinden net kazancı azalır. Farklı ürünlerde farklı stopaj oranları varsa sıralama değişebilir.",
  },
  {
    question: "Faiz oranındaki 1 puan fark ne kadar kazandırır?",
    answer:
      "Bir faiz puanının TL karşılığı ana para, vade, gün esası ve stopaj oranına bağlıdır. Ana para veya vade büyüdükçe bir puanlık farkın net etkisi de artar.",
  },
  {
    question: "Vade uzadıkça teklifler arasındaki fark büyür mü?",
    answer:
      "Faiz oranları arasındaki fark sabit kalırsa vade uzadıkça teklifler arasındaki brüt ve net kazanç farkı genellikle büyür.",
  },
  {
    question: "Ana para arttıkça oran farkının etkisi artar mı?",
    answer:
      "Evet. Faiz kazancı ana parayla orantılı olduğu için aynı oran ve vadede daha yüksek ana para, teklifler arasında daha büyük TL farkı oluşturur.",
  },
  {
    question: "360 ve 365 gün esası neden önemlidir?",
    answer:
      "Faiz formülündeki payda değiştiği için aynı oran ve vade 360 gün esasında 365 gün esasına göre biraz daha yüksek dönemsel faiz üretebilir. Teklifler aynı gün esasıyla karşılaştırılmalıdır.",
  },
  {
    question: "Teklif adlarına banka veya kampanya adı yazılabilir mi?",
    answer:
      "Evet. Teklif alanlarına banka, ürün veya kampanya adı yazılması sonuçların daha kolay izlenmesini sağlar.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Günlük ortalama net kazancın 30 ile çarpılmasıyla bulunan yaklaşık aylık karşılıktır. Gerçek bir 30 günlük banka teklifinin garantili sonucu değildir.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Bankanın belirlediği tarihten sonra dışarıdan gelen veya mevcut bakiye dışında kalan tutarlara özel oran uygulanmasıdır. Mevcut paranız teklif kapsamına girmeyebilir.",
  },
  {
  ...
  {
    question: "Mevduat teklifleri ne sıklıkla değişir?",
    answer:
      "Bankalar oranları piyasa koşulları, tutar, vade ve kampanyalara göre gün içinde dahi değiştirebilir. Karar vermeden hemen önce güncel teklif kontrol edilmelidir.",
  },
  {
...
const howToStructuredData = {
  "@context": "https://schema.org",
  "@type": "HowTo",
  name: "Mevduat faiz teklifleri nasıl karşılaştırılır?",
  description:
    "Aynı ana para, vade, stopaj ve gün esasıyla üç farklı mevduat teklifini karşılaştırma adımları.",
  totalTime: "PT2M",
  step: [
    {
      "@type": "HowToStep",
    ...
    },
    {
      ...
      text: "Karşılaştırmak istediğiniz üç teklifin yıllık brüt faiz oranlarını girin.",
    },
    {
      "@type": "HowToStep",
      position: 3,
    ...
    },
    {
      ...
      text: "Net faiz sıralamasını, vade sonu tutarlarını ve teklifler arasındaki TL farkını değerlendirin.",
    },
  ],
};
...
const articleStructuredData = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Mevduat Faiz Oranı Karşılaştırma Rehberi",
  description:
    "Mevduat faiz tekliflerini aynı koşullarda karşılaştırma, net getiri, stopaj, vade, gün esası ve banka kampanyalarını değerlendirme hakkında kapsamlı rehber.",
          ...
          <div className="mt-10 grid items-center gap-12 lg:grid-cols-[minmax(0,1fr)_420px]">
            <div>
              <span className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-4 py-2 text-sm font-extrabold text-blue-800 shadow-sm">
                ...
                Üç Teklifi Aynı Koşullarda Karşılaştırın
              </span>
              ...
              <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-600">
                Aynı ana para ve vade için üç farklı banka veya kampanya oranını girin; brüt faiz, stopaj, net kazanç, vade sonu tutarı ve teklifler arasındaki TL farkını saniyeler içinde görün.
              </p>
              ...
              <div className="mt-8">
                <ShareButtons
                  title="Mevduat Faiz Oranı Karşılaştırma | HesapRehberi"
                  description="Üç mevduat teklifinin net kazancını ve vade sonu tutarını aynı koşullarda karşılaştırın."
                />
              </div>
            </div>
            ...
            <aside className="rounded-[2rem] border border-slate-200 bg-white/95 p-7 shadow-2xl shadow-slate-200/70 backdrop-blur">
              ...
              <ul className="mt-6 space-y-4">
                {[
                  "Üç teklifin brüt faizi",
                  "Her teklifin stopajı",
                  "Net faiz sıralaması",
                  "En yüksek ve düşük teklif farkı",
          ...
          <div className="min-w-0">
              ...
              {[
                {
                  ...
                  description:
                    "Ana para, vade veya teklif oranları değiştikçe sıralama ve kazanç farkları anında güncellenir.",
                },
                {
                  icon: ReceiptText,
                  title: "Net kazanç sıralaması",
                  description:
                    "Stopaj sonrası net faizleri karşılaştırarak en yüksek getiriyi sağlayan teklifi görürsünüz.",
                },
                {
                  icon: CalendarDays,
            ...
            >
              <SectionHeading
                ...
                title="Mevduat faiz oranı karşılaştırması nedir?"
                description="Mevduat faiz oranı karşılaştırması, aynı yatırım koşullarında farklı tekliflerin net kazançlarını yan yana gösterir. Sağlıklı sonuç için ana para, vade, stopaj ve gün esası sabit tutulmalıdır."
              />

              <div className="mt-8 grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
                <article className="rounded-[2rem] border border-slate-200 bg-white p-7 shadow-sm md:p-9">
                  <h3 className="text-2xl font-black tracking-tight text-slate-950">
                    Faiz tekliflerini karşılaştırmanın çalışma mantığı
                  </h3>
            ...
            >
              <SectionHeading
                ...
                title="Mevduat teklifleri nasıl karşılaştırılır?"
            ...
            >
              <SectionHeading
                ...
                description="Aşağıdaki formüller her teklifin brüt ve net kazancını aynı yöntemle hesaplamanın temelini gösterir. Gün esası, stopaj ve vade bütün teklifler için eşit olmalıdır."
              />
            ...
            >
              <SectionHeading
                ...
                title="Aynı oran farkının farklı vadelerde etkisi"
            ...
            >
              <SectionHeading
                ...
                title="Stopaj teklif karşılaştırmasını nasıl etkiler?"
                description="Stopaj, ana paradan değil brüt faiz kazancından kesilir. Bu nedenle iki teklif aynı brüt faizi sunsa bile farklı kesinti koşulları net getiriyi değiştirebilir."
              />
                ...
                <div className="space-y-5">
                  {[
                    ...
                    },
                    {
                      ...
                      text: "Banka tekliflerini yalnızca brüt faiz oranı üzerinden değil, stopaj sonrası net TL kazancı üzerinden karşılaştırın.",
                      icon: Scale,
                    },
                    {
            ...
            >
              <SectionHeading
                ...
                title="Tekliflerde 360 ve 365 gün esası neden önemlidir?"
            ...
            >
              <SectionHeading
                ...
                title="Teklifleri reel getiri açısından karşılaştırma"
            ...
            >
              <SectionHeading
                ...
                title="Banka mevduat teklifleri adil biçimde nasıl karşılaştırılır?"
                ...
                <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
                  <div>
                    ...
                    <p className="mt-4 max-w-3xl leading-8 text-blue-100">
                      Aynı ana para ve vade için üç farklı banka teklifini brüt
            ...
            >
              <SectionHeading
                ...
                title="Teklif karşılaştırırken vade stratejisi nasıl belirlenir?"
            ...
            >
              <SectionHeading
                ...
                title="Farklı tutar ve vadelerde teklif karşılaştırma senaryoları"
            ...
            >
              <SectionHeading
                ...
                title="Mevduat faiz tekliflerini karşılaştırırken yapılan hatalar"
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-3 leading-8 text-emerald-900">
                      ...
                      koşulu kullanılmalıdır. Ardından teklifler net faiz kazancı
            ...
            >
              <SectionHeading
                ...
                description="Mevduat teklifi kararınızı farklı açılardan değerlendirmek için aşağıdaki hesaplama araçlarını kullanabilirsiniz."
              />
            ...
            >
              <SectionHeading
                ...
                title="Mevduat faiz oranı karşılaştırması hakkında merak edilenler"
              ...
              <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
                <div className="max-w-3xl">
                  ...
                  <p className="mt-4 leading-8 text-blue-100">
                    ...
                    mevduat tekliflerini, reel getiriyi ve erken bozma kaybını
