...
const canonicalUrl =
  "https://hesaprehberi.com/hesaplamalar/mevduat-erken-bozma-kaybi";
        ...
        <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
          <div className="relative overflow-hidden rounded-[32px] bg-gradient-to-br from-rose-700 via-rose-800 to-orange-800 px-6 py-10 text-white sm:px-10 sm:py-12 lg:px-14">
            ...
            <div className="relative flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
              ...
              <Link
                href="/hesaplamalar"
                className="inline-flex h-13 shrink-0 items-center justify-center gap-2 rounded-2xl bg-white px-6 text-sm font-bold text-rose-800 shadow-xl transition hover:-translate-y-0.5 hover:bg-rose-50"
              >
